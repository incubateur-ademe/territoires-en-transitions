...
export const getPieChartOption = ({
  ...
  const { countByResult, total, countByProperty } = countByResponse;
  ...
  return {
    ...
    title: {
      ...
      textStyle: {
        ...
        fontWeight: 700,
        fontSize: 40, // Better to set px instead of rem for SSR
      },
      subtextStyle: {
        color: '#929292',
        fontWeight: 400,
        fontSize: 26, // Better to set px instead of rem for SSR
      },
    },
    series: series,
  };
