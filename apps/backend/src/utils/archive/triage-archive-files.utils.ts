...
export const MAX_ARCHIVED_FILE_SIZE_BYTES = 100 * 1024 * 1024;
...
export function triageArchiveFile({
  ...
  if (file.filesize > MAX_ARCHIVED_FILE_SIZE_BYTES) {
    return {
      kind: 'skipped',
      skippedFile: {
        filename,
        emplacement,
        raison: `Fichier trop volumineux (${file.filesize} octets, limite ${MAX_ARCHIVED_FILE_SIZE_BYTES})`,
      },
    };
  }
