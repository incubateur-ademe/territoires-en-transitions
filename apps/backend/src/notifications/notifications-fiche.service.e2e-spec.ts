...
describe("Notifications envoyées lors de la mise à jour d'une fiche action", () => {
  ...
  let notificationsService: NotificationsFicheService;
  ...
  beforeAll(async () => {
    ...
    notificationsService = app.get(NotificationsFicheService);
  ...
  test('supprime les notifications pending pour les pilotes qui ne sont plus assignés', async () => {
    ...
    await notificationsService.upsertPiloteNotifications({
