...
export const updateActionStatutTrpcErrorEntries: Record<
  SpecificError,
  ErrorConfig
> = {
  NO_ACTION_STATUTS: {
  ...
  MIXED_REFERENTIEL_ACTIONS: {
    code: 'BAD_REQUEST',
    message: 'Les actions ne sont pas toutes dans le même référentiel.',
  },
  MIXED_COLLECTIVITE_ACTIONS: {
    code: 'BAD_REQUEST',
    message: 'Les actions ne sont pas toutes dans la même collectivité.',
  },
  ACTION_NOT_FOUND: {
    code: 'NOT_FOUND',
  ...
  AUDIT_VALIDATED: {
    code: 'BAD_REQUEST',
    message: "L'audit est validé : les statuts ne peuvent plus être modifiés.",
  },
  ...referentielNotWritableTrpcErrorEntry,
};
...
export const updateActionStatutErrorConfig: TrpcErrorHandlerConfig<SpecificError> =
  {
    specificErrors: updateActionStatutTrpcErrorEntries,
  };
