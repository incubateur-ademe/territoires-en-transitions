...
export const indicateurListItemSchema = z.object({
  ...
  estNonSuivi: z.boolean().nullable(),
...
export type IndicateurListItem = z.infer<typeof indicateurListItemSchema>;

export const listIndicateursOutputSchema = z.object({
  count: z.number().int(),
  pageCount: z.number().int(),
  pageSize: z.number().int(),
  page: z.number().int(),
  data: z.array(indicateurListItemSchema),
});

export type ListIndicateursOutput = z.infer<typeof listIndicateursOutputSchema>;
