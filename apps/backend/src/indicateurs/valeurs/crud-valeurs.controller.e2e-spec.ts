...
describe('Indicateurs', () => {
  ...
  it(`Lecture sans acces`, async () => {
    ...
    return request(app.getHttpServer())
      ...
      .expect(403)
      .expect({
        message: `Droits insuffisants, l'utilisateur 17440546-f389-4d4f-bfdb-b0c94a1bd0f9 n'a pas l'autorisation indicateurs.valeurs.read sur la ressource Collectivité ${collectiviteId}`,
        error: 'Forbidden',
        statusCode: 403,
      });
  });
