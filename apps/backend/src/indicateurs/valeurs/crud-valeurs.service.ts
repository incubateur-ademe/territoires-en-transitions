...
export default class CrudValeursService {
  ...
  dedoublonnageIndicateurValeursParSource(
    ...args: Parameters<typeof deduplicateIndicateurValeursBySource>
  ) {
    return deduplicateIndicateurValeursBySource(...args);
  }
  groupeIndicateursValeursParIndicateur(
    ...args: Parameters<typeof groupIndicateurValeurs>
  ) {
    return groupIndicateurValeurs(...args);
  }
  groupeIndicateursValeursParIndicateurEtSource(
    ...args: Parameters<typeof groupIndicateurValeursBySource>
  ) {
    return groupIndicateurValeursBySource(...args);
  }
}
