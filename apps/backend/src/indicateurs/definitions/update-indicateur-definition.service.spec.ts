import { UpdateIndicateurDefinitionRequest } from '@/backend/indicateurs/definitions/update-indicateur-definition.request';
...
describe('UpdateIndicateurDefinitionService', () => {
  ...
  async function updateIndicateur(data: UpdateIndicateurDefinitionRequest) {
    ...
    const updatedIndicateur = await caller.indicateurs.update({
      indicateurId,
      indicateurFields: data,
    });
