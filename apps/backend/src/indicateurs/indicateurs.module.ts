...
import { ListIndicateursRouter } from './definitions/[deprecated]list-definitions/list-indicateurs.router';
import ListIndicateursService from './definitions/[deprecated]list-definitions/list-indicateurs.service';
