import { membreFonctionEnumValues } from '@tet/domain/collectivites';
import {
  boolean,
  integer,
  pgEnum,
...
export const membreFonctionPgEnum = pgEnum(
  'membre_fonction',
  membreFonctionEnumValues
);
...
export const membreTable = pgTable(
  'private_collectivite_membre',
  {
    ...
    collectiviteId: integer('collectivite_id')
      ...
      .notNull(),
    fonction: membreFonctionPgEnum('fonction'),
