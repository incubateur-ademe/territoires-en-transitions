...
import { ListDiscussionsRequestFilters } from '../presentation/discussion.schemas';
...
import { DiscussionMessages, ReferentielEnum } from './discussion.types';
