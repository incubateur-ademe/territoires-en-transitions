  ...
  router = this.trpc.router({
    create: this.trpc.authedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const result = await this.mutateTagService.createTag(input, {
          user: ctx.user,
        });
    ...
    update: this.trpc.authedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const result = await this.mutateTagService.updateTag(input, {
          user: ctx.user,
        });
        return this.getResultDataOrThrowError(result);
      }),
    ...
    delete: this.trpc.authedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        const result = await this.mutateTagService.deleteTag(input, {
          user: ctx.user,
        });
        return this.getResultDataOrThrowError(result);
      }),
