...
export class ImportCollectiviteRelationsService {
   ...
   */
  async importEpciCommunesRelationsFromCsvData(
    csvData: string
   ...
   */
  async importEpciCommunesRelationsFromUrl(): Promise<ImportCollectiviteRelationsResponse> {
    this.logger.log(
  ...
  async importEpciCommunesRelationsFromLocalFile(): Promise<ImportCollectiviteRelationsResponse> {
    this.logger.log(
   ...
   * @param csvData The CSV data as a string
   */
  async importSyndicatEpciRelationsFromCsvData(
    csvData: string
  ): Promise<ImportCollectiviteRelationsResponse> {
   ...
   */
  async importSyndicatEpciRelationsFromLocalFile(): Promise<ImportCollectiviteRelationsResponse> {
    this.logger.log(
