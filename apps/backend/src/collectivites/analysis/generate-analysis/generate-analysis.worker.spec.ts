...
import { GenerateAnalysisWorker } from './generate-analysis.worker';
...
const toWorker = (service: ServiceStub): GenerateAnalysisWorker =>
  new GenerateAnalysisWorker(service as never);

describe('GenerateAnalysisWorker.process', () => {
...
describe('GenerateAnalysisWorker.onJobFailed', () => {
