...
export type ListPersonnalisationThematiquesInput = {
...
export class ListPersonnalisationThematiquesService {
  ...
  async listThematiques(
    input: ListPersonnalisationThematiquesInput,
    ...
    return this.databaseService.db.transaction(async (tx) =>
      this.listThematiquesRepository.listByCollectiviteId(input, tx)
    );
  }
}
