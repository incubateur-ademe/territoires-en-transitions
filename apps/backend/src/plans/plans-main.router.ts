...
import { ClassificationLeviersRouter } from './classification-leviers/classification-leviers.router';
...
export class PlanMainRouter {
  constructor(
    ...
    private readonly classificationLeviersRouter: ClassificationLeviersRouter
  ) {}
  ...
  router = this.trpc.router({
    ...
    classificationLeviers: this.classificationLeviersRouter.router,
  });
