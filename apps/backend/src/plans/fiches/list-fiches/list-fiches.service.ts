...
export default class ListFichesService {
  ...
  private async listFichesQuery({
    ...
    data: {
      id: number;
      pilotes: FicheWithRelations['pilotes'];
      sharedWithCollectivites: FicheWithRelations['sharedWithCollectivites'];
    }[];
    count: number;
  }>;
