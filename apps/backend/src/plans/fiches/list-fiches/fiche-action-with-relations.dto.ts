import { collectiviteSchema } from '@tet/backend/collectivites/shared/models/collectivite.table';
import { idNameSchema } from '@tet/backend/collectivites/shared/models/id-name.schema';
import { personneTagOrUserSchemaWithContacts } from '@tet/backend/collectivites/shared/models/personne-tag-or-user.dto';
import {
  tagSchema,
  tagWithCollectiviteIdSchema,
} from '@tet/backend/collectivites/tags/tag.table-base';
import { effetAttenduSchema } from '@tet/backend/shared/effet-attendu/effet-attendu.table';
import { tempsDeMiseEnOeuvreSchema } from '@tet/backend/shared/models/temps-de-mise-en-oeuvre.table';
import { sousThematiqueSchema } from '@tet/backend/shared/thematiques/sous-thematique.table';
import { thematiqueSchema } from '@tet/backend/shared/thematiques/thematique.table';
import z from 'zod';
import {
  Cible,
