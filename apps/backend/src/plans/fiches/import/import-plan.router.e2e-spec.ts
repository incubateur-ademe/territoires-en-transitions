  ...
  test('Test erreur colonne', async () => {
    ...
    await expect(() => caller.plans.fiches.import(input)).rejects
      .toThrowError(`<strong>Erreur rencontrée dans le fichier Excel :</strong><br>
          ...
          <strong>Les colonnes attendues sont :</strong> <pre>Axe (x),Sous-axe (x.x),Sous-sous axe (x.x.x),Titre de la fiche action,Descriptif,Instances de gouvernance,Objectifs,Indicateurs liés,Structure pilote,Moyens humains et techniques,Partenaires,Direction ou service pilote,Personne pilote,Élu·e référent·e,Participation Citoyenne,Financements,Financeur 1,Montant € HT,Financeur 2,Montant € HT,Financeur 3,Montant € HT,Budget prévisionnel total € HT,Statut,Niveau de priorité,Date de début,Date de fin,Action en amélioration continue,Calendrier,Actions liées,Fiches des plans liées,Notes,Etapes de la fiche action,Documents et liens</pre><br>
          <strong>Les colonnes données sont   :</strong> <pre>Axe (x),Sous-axe (x.x), Sous-sous axe (x.x.x),Titre de la fiche action,Descriptif,Instances de gouvernance,Objectifs,Indicateurs liés,Structure pilote,Moyens humains et techniques,Partenaires ,Direction ou service pilote,Personne pilote,Élu·e référent·e ,Participation Citoyenne,Financements,Budget prévisionnel total € HT,Financeur 1,Montant € HT,Financeur 2,Montant € HT,Financeur 3,Montant € HT,Statut ,Niveau de priorité,Date de début,Date de fin,Action en amélioration continue,Calendrier,Actions liées,Fiches des plans liées,Notes,Etapes de la fiche action,Documents et liens</pre><br><br>
