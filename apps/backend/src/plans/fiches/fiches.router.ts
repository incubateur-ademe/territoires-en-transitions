...
import { FicheActionNoteRouter } from './fiche-action-note/fiche-action-note.router';
...
export class FichesRouter {
  constructor(
    ...
    private readonly ficheActionNoteRouter: FicheActionNoteRouter
  ) {}
  ...
  router = this.trpc.mergeRouters(
    ...
    this.ficheActionNoteRouter.router
  );
