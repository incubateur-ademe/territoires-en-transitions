...
export class ReportsService {
  ...
  private readonly PIE_CHART_WIDTH = 600;
  ...
  async loadCollectiviteLogo(mediaDir: string, presentation: Automizer) {
  ...
  async addPlanSummarySlide(args: {
    presentation: Automizer;
    mediaDir: string;
    fiches: FicheWithRelations[];
    planGeneralInfo: ReportPlanGeneralInfo;
  ...
  async addPlanProgressSlide(args: {
    presentation: Automizer;
    mediaDir: string;
    fiches: FicheWithRelations[];
    planGeneralInfo: ReportPlanGeneralInfo;
