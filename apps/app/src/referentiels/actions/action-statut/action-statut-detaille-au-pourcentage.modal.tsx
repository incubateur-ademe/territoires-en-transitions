...
import { ActionExplicationField } from '../../../../app/(authed)/collectivite/[collectiviteId]/(standard)/(acces-restreint)/referentiel/[referentielId]/action/[actionId]/_components/action-explication.field';
