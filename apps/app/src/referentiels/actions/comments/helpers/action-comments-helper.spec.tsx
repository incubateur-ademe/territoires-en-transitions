...
describe('getActionsAndSubActions', () => {
  it('should return an empty array for null input', () => {
    const result = getActionsAndSubActions(null);
    expect(result).toEqual([]);
  });

  it('should return an empty array for undefined input', () => {
    const result = getActionsAndSubActions(undefined);
    expect(result).toEqual([]);
  });

  it('should return an empty array for an empty object', () => {
    const result = getActionsAndSubActions({});
    expect(result).toEqual([]);
  });
  ...
  it('should extract data from a single action node', () => {
    ...
    const result = getActionsAndSubActions(actionNode);
  ...
  it('should correctly extract actions and sub-actions from real-world CAE action tree', () => {
    ...
    const actualResult = getActionsAndSubActions(actionNode);
