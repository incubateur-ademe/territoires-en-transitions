// Tranches de pourcentages utilisées pour filtrer les colonnes de score
// (ex. « % fait ») du tableau Referentiel.

export const scoreRangeItems = [
  { value: '0', label: '0 %' },
...
export const scoreRangeBoundaries = {
