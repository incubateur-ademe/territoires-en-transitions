 ...
 */
export const FileItem = (props: FileUploadItem): JSX.Element | null => {
  const { status } = props;
...
const FileItemRunning = (props: FileUploadItem): JSX.Element => {
...
const FileItemCompleted = (props: FileUploadItem): JSX.Element => {
  const { file } = props;
  return (
...
const FileItemFailed = (props: FileUploadItem): JSX.Element => {
