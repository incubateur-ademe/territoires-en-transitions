...
| 8 | **Routes** : `/demarche-pcaet/vue-dreal` (dashboard) et `/demarche-pcaet/vue-dreal/[epciId]` (consultation) | Calqué sur le pattern existant (`polluants-atmospheriques`, `[demarcheId]/vulnerabilite`). |
