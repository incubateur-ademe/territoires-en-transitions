...
const PersonneTagDropdown = ({
  ...
  const getSelectedPersonnes = useCallback(
    (values?: OptionValue[]) =>
  ...
  const handleTagCreate = useCallback(
    ...
    [collectiviteId, createTag, getSelectedPersonnes, onChange, values]
  );
...
export default PersonneTagDropdown;
