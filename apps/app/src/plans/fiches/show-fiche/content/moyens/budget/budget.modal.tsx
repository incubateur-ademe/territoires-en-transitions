import { useDeleteBudgets } from '@/app/plans/fiches/update-fiche/data/use-delete-budgets';
import { useUpsertBudgets } from '@/app/plans/fiches/update-fiche/data/use-upsert-budgets';
import {
  FicheBudget,
  FicheBudgetCreate,
  FicheWithRelations,
...
export const BudgetModal = ({
  ...
  const handleSave = () => {
    const newBudgets: FicheBudgetCreate[] = [];
