...
describe('scroll to axe management', () => {
  describe('basic cases', () => {
    ...
    it('should return undefined with multple axes with depth 1', () => {
      /*
      Hierarchy:
      Axe 1 (depth 0)
      ├── Axe 2 (depth 1)
  ...
  describe('getCanBeScrolledTo', () => {
    describe('basic cases', () => {
      ...
      Hierarchy:
      Axe 1 (depth 0) [open]
      ├── Axe 2 (depth 1) [open] ← Testing this axe
      │   └── Axe 3 (depth 2) [open]
    ...
    describe('common ancestor scenarios', () => {
      it('should return true when axe is the deepest common ancestor', () => {
        /*
      Hierarchy:
      Axe 1 (depth 0) [open]
      ├── Axe 2 (depth 1) [open]
      ...
      */
      ...
      it('should return true when checking axe with deepest depth', () => {
        /*
      Hierarchy:
      Axe 1 (depth 0) [open]
      ├── Axe 2 (depth 1) [open]
