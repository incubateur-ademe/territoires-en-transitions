...
const referenceYear = toYear(Math.min(2020, currentYear));
const years = [referenceYear, toYear(Math.min(2024, currentYear))];
...
describe('ReferenceYearField', () => {
  ...
  it('appelle onReferenceYearChange après Entrée avec une année valide', () => {
    ...
    expect(onReferenceYearChange).toHaveBeenCalledWith(toYear(2018));
  });
