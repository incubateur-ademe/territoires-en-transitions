...
export const ForgottenPassword = (props: LoginPropsWithState) => {
  ...
  return (
    <form
      ...
      data-test="auth.forgotten-password.form"
    >
      <Field
        title={appLabels.authEmailDeConnexion}
        htmlFor="email"
        state={errors.email ? 'error' : 'info'}
        message={
          errors.email?.message?.toString() || appLabels.authAccesBoiteMailAide
        }
      >
        <Input
          id="email"
