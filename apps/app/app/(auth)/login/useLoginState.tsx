...
import {
  ...
  LoginData,
  LoginView,
} from '@/app/auth/components/Login';
import {
  isScoreStrongEnough,
  useGetPasswordStrength,
} from '@/app/auth/components/PasswordStrengthMeter/useGetPasswordStrength';
import { ResendFunction, VerifyOTPData } from '@/app/auth/components/VerifyOTP';
