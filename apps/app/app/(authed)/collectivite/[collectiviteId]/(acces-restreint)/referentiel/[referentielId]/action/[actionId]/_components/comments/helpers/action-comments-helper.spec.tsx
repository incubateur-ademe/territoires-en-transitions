...
import {
  getActionsAndSubActionsIdIdentifiantAndName,
  orderDiscussions,
} from './action-comments-helper';
...
describe('orderDiscussions', () => {
  type TestDiscussion = Parameters<typeof orderDiscussions>[1][number];
  ...
  it('should return a new array preserving order when orderBy is unhandled', () => {
    ...
    const result = orderDiscussions('unknown', discussions);
  ...
  it('should sort discussions by actionId in ascending order', () => {
    ...
    const result = orderDiscussions('actionId', discussions);
  ...
  it('should sort discussions by the most recent message date when ordering by createdAt', () => {
    ...
    const result = orderDiscussions('createdAt', discussions);
