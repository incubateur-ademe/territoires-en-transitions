...
> & {
  ...
  catalogues?: string[]; // action catalogues include cae, eci but also biodiversite, eau
  scores_catalogue?: Record<string, ActionPointScoreType>;
  ...
  extendApi(
    actionDefinitionSeulementIdObligatoireSchema
      .extend({
        ...
        catalogues: z.string().array().optional(),
        scores_catalogue: z
