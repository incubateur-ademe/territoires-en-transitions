...
export default class ReferentielsService {
  ...
  getActionDefinitionTagsQuery() {
    return this.databaseService.db
      ...
      .groupBy(actionDefinitionTagTable.action_id, actionDefinitionTagTable.referentiel_id)
      .as('action_tags');
  }
  ...
  async getReferentiel(
    ...
    const actionDefinitions = await this.databaseService.db
      ...
      .leftJoin(actionTagsQuery,
        and(
          eq(actionDefinitionTable.action_id, actionTagsQuery.action_id),
          eq(actionDefinitionTable.referentiel_id, actionTagsQuery.referentiel_id)
        )
      )
      .where(
        and(
