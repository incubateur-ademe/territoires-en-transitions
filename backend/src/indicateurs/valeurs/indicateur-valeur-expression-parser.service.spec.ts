...
describe('IndicateurValeurExpressionParserService', () => {
  ...
  describe('parseAndEvaluateExpression', () => {
    ...
    test('val(cae_1.e) + limite(cae_1.g) + cible(cae_1.h) + ct_val(cae_1.i) with all values', async () => {
      expect(
        indicateurValeurExpressionParserService.parseAndEvaluateExpression(
          'val(cae_1.e) + limite(cae_1.g) + cible(cae_1.h) + ct_val(cae_1.i)',
          {
            'cae_1.e': 100,
          },
          {
