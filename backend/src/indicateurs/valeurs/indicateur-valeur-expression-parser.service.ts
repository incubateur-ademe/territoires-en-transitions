...
const indicateurValeurExprLexer = new Lexer(allTokens);

class IndicateurValeurExprParser extends CstParser {
  constructor() {
    super(allTokens);
...
class IndicateurValeurExpressionVisitor extends BaseCSTVisitor {
