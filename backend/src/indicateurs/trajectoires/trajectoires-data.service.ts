...
import { CollectiviteResume, collectiviteType } from '@/backend/collectivites/shared/models/collectivite.table';
...
export default class TrajectoiresDataService {
  ...
  async verificationDonneesSnbc(
    ...
    if (!epci) {
      ...
      if (collectivite.collectivite.type != collectiviteType.EPCI) {
