...
#### Actions
##### Identifier un élu référent en charge de la politique économie circulaire
```yaml
id: 1.1.1.1
points: 20
```

##### Engager la politique économie circulaire
```yaml
id: 1.1.1.2
points: 30
```
...
##### Cibler dans la stratégie la société civile, les acteurs publiques et les acteurs économiques
```yaml
id: 1.1.4.3
points: 15
```

##### Couvrir dans la stratégie tous les axes de l'eci
```yaml
id: 1.1.4.4
points: 15
```
...
##### Intégrer dans le programme d'actions des actions sur le pilier écoconception de l'économie circulaire
```yaml
id: 1.1.4.9
points: 4
```
