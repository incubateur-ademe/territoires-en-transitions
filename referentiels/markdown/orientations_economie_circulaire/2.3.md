...
• Réaliser des études de faisabilités technico-économiques sur des solutions pour améliorer la valorisation de flux sélectionnés en tenant compte des problématiques associées aux détournements de flux (sous-alimentation des installations de traitement, reconversion des installation, etc.)
...
L'étude d'optimisation peut faire état du taux d'utilisation des installations actuelles et l'optimiser.
...
#### Actions
##### Concrétiser au moins une solution et avoir moins d'un tiers des solutions retenues dans l’étude de concrétisées
```yaml
id: 2.3.2.1
```
...
#### Actions
##### Suivre l'effet de la concrétisation
```yaml
id: 2.3.3.1
```
