...
• Preuve du déroulé des évènements mettant en avant la moindre consommation : programme, feuille d'émargement, bilan de l'évènement, etc.

#### Actions
##### Disposer de support(s) de communication recensant les solutions sobres
```yaml
id: 3.3.1.1
```

##### Organiser des ateliers de sensibilisation à la consommation sobre
```yaml
id: 3.3.1.2
```

##### Soutenir financièrement ou organiser des évènements mettant en avant la moindre consommation
```yaml
id: 3.3.1.3
```


### Promouvoir et définir  la politique de sobriété
```yaml
id: 3.3.2
points: 25
```
#### Description
La collectivité sensibilise et forme à la sobriété ses élus et ses techniciens.
...
#### Exemples
Sensibiliser et former les élus et techniqciens sur les sujets suivants: 
...
Mettre en place un groupe de travail ou une équipe dédiée à la construction de la vision et du plan d'action global sur la sobriété.
...
##### Formaliser dans un document une vision et un plan d'action de la collectivité sur la sobriété
```yaml
id: 3.3.2.4
```


### Mettre en place des actions de consommation responsable et de sobriété sur ses compétences
```yaml
id: 3.3.3
points: 25
```
...
##### Réaliser des actions sur au moins 3 compétence de la collectivité
```yaml
id: 3.3.3.3
```
...
• Délibération décrivant les modalités du dispsotif de soutien à une offre commerciale plus sobre
• Délibération décrivant le dispositif d’accompagnement au changement de modèle économique
• Délibération décrivant les critères d’exclusion de subventions aux associations promouvant des activités non sobres

#### Actions
##### Mettre en place au moin une action
```yaml
id: 3.3.4.1
```
