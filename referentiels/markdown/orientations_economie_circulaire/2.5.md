...
#### Actions
##### Des moyens sont mis en place pour identifier ou fédérer des réseaux d'acteurs sur le territoire
```yaml
id: 2.5.3.1
points: 8
```

##### Des moyens sont mis en place pour accompagner les projets dans leur définition
```yaml
id: 2.5.3.2
points: 8
```

##### Des moyens sont mis en place soutenir le déploiement des projets
```yaml
id: 2.5.3.3
points: 8
```
