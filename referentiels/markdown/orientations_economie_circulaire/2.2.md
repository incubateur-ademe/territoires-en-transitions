...
• 90% de collecte pour recyclage des bouteilles et flacons pour boissons en 2029
...
#### Actions
##### Disposer de bac pucés et contrôler l'accès à la déchèterie
```yaml
id: 2.2.3.1
```

##### Optimiser le réseau de déchèterie
```yaml
id: 2.2.3.2
```

##### Développer l'accueil de nouvelles filières en déchèteries (liés aux rep ou non)
```yaml
id: 2.2.3.3
```
