...
### Aider à l'action du grand public
```yaml
id: 5.1.2
points: 40
```
...
Mise en place des accords avec un ou plusieurs acteurs associatifs grand public du territoire permettant de progresser sur une thématique particulière de l'Economie Circulaire. Chaque accord devrait comprendre des indicateurs de performance pour mesurer la réussite du partenariat.
