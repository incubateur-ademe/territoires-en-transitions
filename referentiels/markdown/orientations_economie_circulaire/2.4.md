...
##### Etude réalisée et pistes identifiées
```yaml
id: 2.4.1.2
```

##### Priorisation d'actions réalisée
```yaml
id: 2.4.1.3
```
...
##### Objectifs chiffrés sont donnés
```yaml
id: 2.4.2.2
```
...
##### Pilotage de la progression est mis en place
```yaml
id: 2.4.2.4
```
...
##### Communication écrite réalisée
```yaml
id: 2.4.5.2
```

##### Communication orale (réunions d'information, etc.)
```yaml
id: 2.4.5.3
```

##### Communication sur les impacts de la gestion des déchets
```yaml
id: 2.4.5.4
```

##### Communication pour la prévention des comportements indésirables
```yaml
id: 2.4.5.5
```
