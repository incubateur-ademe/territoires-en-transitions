...
```
###### Description 
Faire apparaître ces principes ou a minima la limitation des pointes de consommation: prix différenciés selon les saisons (été/hiver), différenciation heure pleine/heure creuse, pas de réduction liée à la quantité, modèles tarifaires novateurs (par ex. tarif d'efficacité), etc.
