...
3. **Cleanup ciblé** — les données entièrement isolées peuvent être laissées au reset CI, mais toute mutation de données seed/globales doit être restaurée via `onTestFinished`
