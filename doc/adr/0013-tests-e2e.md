...
- D'une part les routes backend associées sont déjà exhaustivement testées.
...
Un argument en faveur de l'utilisation des roles/noms réside dans le fait que cela va également dans le sens d'une bonne accessibilité.
