...
2. L'ajout d'une en-tête fixe ou encore d'une pagination est rapide et simple à mettre en place.
...
- d'intégrer une en-tête par défaut, avec logos et pagination
...
- la requête de la donnée au composant parent uniquement lorsqu'un click de l'utilisteur est détecté (optionnel)
