...
- réutiliser `IndicateurCard`, sélecteur d'indicateurs, filtres et le détail mensuel du socle ;
- si un tableau de saisie dédié est requis, le composer sur `IndicateurPeriod` dans cette phase ;
