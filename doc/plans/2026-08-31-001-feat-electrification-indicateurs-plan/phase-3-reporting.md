...
Si l'état soumis doit être historisé (revue ADEME à date fixe), définir un contrat de snapshot
propre au reporting. Les anciennes tables SQL de snapshot du diagnostic PCAET ayant été
supprimées, elles ne constituent plus un modèle à réutiliser. Sinon, assumer que le reporting
montre l'état courant.
