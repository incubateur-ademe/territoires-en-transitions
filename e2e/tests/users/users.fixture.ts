...
import { FuncArgs, SupabaseClient } from '../fixtures/supabase-client.utils';
...
type TestCollectivite =
  Database['public']['Tables']['collectivite_test']['Row'];
...
export class Users {
  ...
  async addUser(args: FuncArgs<'test_add_random_user'> = {}) {
  ...
  async addCollectivite(nomCollectivite?: string) {
    ...
    return this.supabaseClient.rpc<TestCollectivite>(
  ...
  async addCollectiviteAndUser(
    args: Omit<FuncArgs<'test_add_random_user'>, 'collectivite_id'> & {
