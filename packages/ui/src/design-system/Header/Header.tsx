...
export const Header = ({
  ...
  rootUrl = '/',
  logos = [
    <RepubliqueFrancaiseLogo key="logo-republique-francaise" />,
    <AdemeLogo key="logo-ademe" />,
    <ProgrammeTeTeLogo key="logo-programme-tete" />,
    <TerritoiresEnTransitionsLogo key="logo-territoires-en-transitions" />,
  ],
  mainNav,
  secondaryNav,
  id,
