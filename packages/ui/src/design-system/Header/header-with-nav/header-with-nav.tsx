...
import ademeSrc from './ademe.jpg';
      ...
      <div className="flex items-center justify-start -mx-4 lg:py-6">
        <div className="fr-header__brand fr-enlarge-link">
          ...
          <div className="fr-header__service">
            ...
            >
              <p className="fr-header__service-title m-0">{props.title}</p>
              <p className="fr-header__service-tagline m-0">{props.subtitle}</p>
            </a>
          </div>
        </div>
        <div className="fr-header__tools">
          <div className="fr-header__tools-links">
            {AccesRapide && <AccesRapide {...props} />}
          </div>
        </div>
      </div>
    </div>
...
const Menu = (props: HeaderPropsWithModalState) => {
  const { modalOpened, setModalOpened, AccesRapide, MenuPrincipal } = props;
  ...
  return (
    ...
    >
      <div className="w-full max-w-[90rem] mx-auto px-2 md:px-4 lg:px-6">
        ...
        {MenuPrincipal && <MenuPrincipal {...props} />}
