...
import {BadgesSelectFilters} from './BadgesSelectFilters';
import {useState} from 'react';
import {OptionValue, SelectMultipleOnChangeArgs} from '@design-system/Select';

const meta: Meta<typeof BadgesSelectFilters> = {
  title: 'Components/Filters/BadgesSelectFilters',
  component: BadgesSelectFilters,
};

export default meta;

type Story = StoryObj<typeof BadgesSelectFilters>;

/** Version utilisée dans le panier d'actions */
