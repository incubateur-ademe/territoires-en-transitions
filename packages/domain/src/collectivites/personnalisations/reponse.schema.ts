...
/**
 * Valeur d'une réponse à une question de type proportion.
 *
 * Contrat API : ratio dans [0, 1] (ex. 0.75 pour 75 %), aussi bien en
 * écriture (setReponse) qu'en lecture (listQuestionsReponses). L'UI affiche
 * et saisit en pourcentage [0, 100] et applique la conversion côté client
 * (cf. transform-reponse.ts) ; tout appel direct à l'API doit utiliser le
 * ratio.
 */
