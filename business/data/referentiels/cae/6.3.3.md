...
```
#### Actions
##### Le partenariat ou l'implication de la collectivité avec les acteurs décrits précédemment a fait l'objet d'une discussion 
```yaml
identifiant:  6.3.3.2.1
```
###### Description 
Discussion inscrite dans un compte-rendu, voire d’une délibération si nécessaire au niveau de l'organe délibérant
