...
```
## Description
La collectivité met en place des actions d'économie circulaire vers les acteurs économiques du territoire,  sur l'ensemble des 7 piliers de l'économie circulaire.
Les actions prises en compte dans cette orientation doivent être en cours de validité ou avoir été réalisées dans les 4 dernières années.

## Contexte

**Contexte – Agir collectivement**

<a href="https://www.optigede.ademe.fr/ecologie-industrielle-territoriale-enjeux">Ecologie Industrielle et Territoriale</a>

<a href="https://www.optigede.ademe.fr/gestion-collective-dechets-entreprises-introduction">Gestion collective</a>

<a href="https://www.optigede.ademe.fr/bao-destinee-aux-relais-professionnels-pour-accompagner-les-entreprises-vers-la-reduction-des-dechet">Rôles des relais professionnels et collectivités</a>
...
<a href="https://www.auvergne-rhone-alpes.cci.fr/?q=environnement/optim/dechets">Exemple de réduction du coût des déchets</a>
...
```
#### Description
Dans une logique de sobriété, la collectivité met en place des actions de sensibilisation et de formation à l'attention des acteurs économiques sur les 7 piliers de l'économie circulaire.

#### Exemples
Entamer des démarches auprès des acteurs économiques ou de leurs représentants locaux (fédérations, réseaux, organismes consulaires, etc.) en fonction des compétences et des enjeux de la collectivité. La collectivité peut s'appuyer sur les actions identifiées dans son diagnostic initial.
Diffuser des documents d'information (déjà disponibles auprès des Communautés de communes, Conseils régionaux, ADEME ou réalisés en propre) sur l'éco-conception, les achats responsables, l'économie de la fonctionnalité, la prévention des déchets, etc.
Promouvoir des MOOCs, des formations ou des évènements à destination des entreprises et des représentants locaux.
...
#### Critère
Actions de sensibilisation et de formation en lien avec les 7 piliers, réalisées dans les 4 dernières années, avec estimation du nombre de personnes touchées
...
#### Exemples
Lancer ou participer à des initiatives en matière d'économie circulaire  réalisées par les représentants locaux d'entreprises et/ou d'autres acteurs économiques :
Mettre en place des services mutualisés sur une ZI/ZAC ayant un impact sur l'économie circulaire.
Mettre à disposition des équipements ou des lieux favorisant la collecte de flux pour le recyclage ou les plateformes d'échanges pour le réemploi et la réutilisation (bourse des déchets, etc.).
Identifier et mettre à disposition du foncier en faveur d'installations : déchèteries pour les professionnels, etc.
...
```
#### Description
La collectivité déploie des partenariats ayant abouti à des actions avec les acteurs économiques de son territoire sur les 7 piliers de l'économie circulaire.
...
Soutenir l'animation d'une bourse d'échange pour le réemploi et la réutilisation.
etc.

#### Critère
Cartographie de représentants d'acteurs économiques à potentiel de partenariat
...
##### Construire des accords avec les représentants d'acteurs économiques sur 1 à 2 piliers
```yaml
identifiant: 5.3.3.2
pourcentage: 15
```

##### Construire des accords avec les représentants d'acteurs économiques sur 3 à 4 piliers
```yaml
identifiant: 5.3.3.3
pourcentage: 15
```

##### Construire des accords avec les représentants d'acteurs économiques sur 5 à 7 piliers
```yaml
identifiant: 5.3.3.4
pourcentage: 20
```
