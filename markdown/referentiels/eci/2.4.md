...
- DUERP
- Autre preuve de la conformité des installations (selon la nature de l'installation)
...
Pour les collectivités portant la compétence collecte et traitement, les niveaux 2.4.2 et 2.4.4 peuvent faire objet d’un plan d’action unique.
...
- Autre(s) support(s) de communication comme un article dans un journal local, la présence d'informations sur les factures, une commission locale d'information, etc.
