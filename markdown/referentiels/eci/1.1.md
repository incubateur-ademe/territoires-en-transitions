...
##### Désigner un chef de projet économie circulaire; en cas d’indisponibilité (arrêt maladie longue durée, maternité, départ…), son remplacement est une priorité (pas d’absence de longue durée (ex : plus de 3 mois))
```yaml
identifiant: 1.1.1.3
pourcentage: 20
```
