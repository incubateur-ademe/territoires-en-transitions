...
Si le service d’information n’est pas assuré par la collectivité il peut l’être par d’autres structures de conseil (un espace conseil France Rénov, une agence d’urbanisme, le CAUE, l’ADIL, une association environnementale).   
...
```
#### Description
Exemple pour une commune non compétente : elle repère les différentes cibles et fait une communication différenciée, elle facilite le repérage des bénéficiaires en relayant les opérations portées par l’espace conseil France Rénov...
...
#### Actions
##### S'appuyer a minima sur les missions de son espace conseil France Rénov pour guider le particulier dans son parcours de rénovation de son logement. 
```yaml
