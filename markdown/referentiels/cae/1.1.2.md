...
Parmi les outils stratégiques dont disposent les collectivités, le Plan Climat Air Énergie Territorial (PCAET) est la référence en matière de réduction des émissions de GES et d’adaptation au changement climatique, car obligatoire pour les EPCI avec une population supérieure à 20 000 habitants. Pour le construire, la première étape indispensable consiste à réaliser un diagnostic climat-air-énergie.
...
Afin de quantifier l’impact des activités humaines sur le changement climatique, diverses méthodes de comptabilisation des émissions de gaz à effet de serre se sont développées ces 20 dernières années. Ces méthodes évoluent en fonction de l’objet étudié : territoire, organisation, produit, etc. 
Le terme générique « Bilans GES » regroupe l’ensemble de ces démarches à l’échelle des organisations. Ce diagnostic permet d’avoir un état des lieux sur une année d’activité, de l’ensemble de ses émissions de gaz à effet de serre, réparties par poste d’émission, dans le but d’identifier des leviers d’actions de réduction et de mettre en place un plan de transition efficace et cohérent. 

<a href="https://bilans-ges.ademe.fr/ressources/contexte-et-enjeux-de-la-comptabilite-carbone">https://bilans-ges.ademe.fr/ressources/contexte-et-enjeux-de-la-comptabilite-carbone</a>

**Réglementation**

Art. L. 229-25 du code de l’environnement relatif au bilan GES (obligatoire pour les collectivités territoriales de plus de 50 000 habitants).

Art. R. 229-51 du code de l’environnement relatif au PCAET (obligatoire pour les EPCI > 20 000 habitants).

## Ressources

Centre de ressources Bilans GES de l’ADEME (plateforme nationale pour la publication des bilans GES et ressources) : <a href="https://bilans-ges.ademe.fr ">https://bilans-ges.ademe.fr </a>

Données énergétiques territoriales pour la planification et l'action Energie-Climat, 2019 : 
<a href="https://librairie.ademe.fr/changement-climatique-et-energie/1322-donnees-energetiques-territoriales-pour-la-planification-et-l-action-energie-climat-n3-9791029711282.html ">https://librairie.ademe.fr/changement-climatique-et-energie/1322-donnees-energetiques-territoriales-pour-la-planification-et-l-action-energie-climat-n3-9791029711282.html </a>
...
Un nouveau diagnostic territorial a été réalisé en 2019 et est détaillé ici : 
<a href="https://planclimat.grenoblealpesmetropole.fr/20-nouveau-plan-climat-air-energie.htm">https://planclimat.grenoblealpesmetropole.fr/20-nouveau-plan-climat-air-energie.htm</a>
...
## Actions
### Être en conformité vis-à-vis des obligations réglementaires (PCAET et BEGES)
```yaml
identifiant: 1.1.2.0 
pourcentage : 0
categorie: bases
...
```
#### Actions
##### Être en conformité vis-à-vis des obligations réglementaires BEGES
```yaml
