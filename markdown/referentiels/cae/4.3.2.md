...
##### Faire connaître les nouvelles règles du décret Plan d'actions pour les mobilités actives (PAMA) 2015 et verbaliser les enfreintes
```yaml
...
##### Anticiper et/ou réduire les conflits d’usage 
```yaml
