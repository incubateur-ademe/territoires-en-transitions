...
```
###### Description
par exemple : ligue EnR, Territoire Engagé Climat-Air-Énergie, Rubans du développement durable, etc...
...
##### Communiquer aux acteurs du territoire des démarches et actions climat air énergie menées sur le territoire (Territoire Engagé Transition Écologique Climat-Air-Énergie, TEPOS, PCAET…) et leur mettre à disposition le suivi et l’évaluation de ces démarches (transparence de la collectivité)
```yaml
