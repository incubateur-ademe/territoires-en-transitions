...
```
###### Description
Cela limite au global les consommations d'énergie liées à l'entretien, les quantités d'engrais (notamment chimiques) et d'eau dans l'objectif "zéro phyto" obligatoire à partir de 2017.
...
##### Mettre en place un outil à une échelle plus large
```yaml
