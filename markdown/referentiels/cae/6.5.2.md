...
#### Actions
##### Placer une personne au sein de la collectivité spécifiquement chargée des actions de sensibilisation auprès des habitants et formée aux questions de changement de comportement
```yaml
...
#### Actions
##### Privilégier des objets incitant aux comportements éco-responsables à l'occasion de manifestations ou à l'occasion de récompenses à des jeux ou objets "promotionnels"
```yaml
