...
## Ressources
- <a href="https://librairie.ademe.fr/urbanisme-et-batiment/5662-en-chemin-vers-la-planification-bas-carbone-9791029720055.html">En chemin vers la planification bas carbone : cahier de recommandations</a>, et en particulier la recommandations n°8 : Dès le départ travailler avec les instructeurs ADS et les élus.

- <a href="https://outil2amenagement.cerema.fr/sites/outils2am/files/fichiers/2023/09/Fiche_outils_Le%20site%20patrimonial%20remarquable_SPR.pdf">Fiche outils du CEREMA sur le SPR - Site patrimonial remarquable</a>
...
##### Mettre en place le dispositif de "site patrimonial remarquable" (SPR) pour faciliter et simplifier la protection des enjeux patrimoniaux et paysagers identifiés sur un même territoire et maîtriser la performance environnementale des travaux réalisés dans le périmètre d’un SPR
```yaml
identifiant: 1.3.3.1.5
```
###### Description
Anciennement "Mettre en place des aires de mise en valeur de l’architecture et du patrimoine (AVAP) pour établir un consensus en amont dans les secteurs où la protection du patrimoine architectural représente un frein fort à la rénovation énergétique du bâti"
Fiche outils du CEREMA sur le SPR disponible dans les ressources de la mesure 
...
#### Actions
##### Joindre aux formulaires de demande de permis de construire des plaquettes de présentation des acteurs ressources du territoire sur le logement (espace conseil France Rénov, CAUE, ADIL...) ou de recommandations (avec exemples locaux)
```yaml
identifiant: 1.3.3.2.1
```

##### Prendre des rendez-vous avec un conseiller France Rénov ou le CAUE pour chaque demande de permis de construire
```yaml
...
```
###### Description
Espace conseil France Rénov, prêt de matériel de mesure aux maîtres d’ouvrage, etc.
