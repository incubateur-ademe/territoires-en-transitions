...
#####  Prévenir et gérer les déchets conformément à la réglementation 
```yaml
identifiant: 1.2.3.1.6
```
###### Description
Prévenir (sensibilisation des agents, des services, etc.) et gérer les déchets conformément à la réglementation, réemployer et recycler les déchets occasionnés par les construction/déconstruction des bâtiments, respecter l’obligation de tri 5 flux pour les services (inter)communaux. 
