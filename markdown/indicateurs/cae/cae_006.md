# Production de déchets ménagers et assimilés (avec déblais et gravats) par habitant (kg/hab)
```yaml
id: cae_6.a
identifiant: 6.a
unite: kg/hab
...
- Valeur limite : 573 kg/hab

- Valeur cible : 480 kg/hab
...
- Valeur limite : 265 kg/hab

- Valeur cible : 120 kg/hab
