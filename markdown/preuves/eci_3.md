...
# Le document formalisant le SPASER - Schéma de Promotion des Achats Publics Socialement et Ecologiquement Responsables 
```yaml
action_id: eci_3.2.0
```
## Description
...
# Justificatif de participation à un réseau d'acheteurs ou club d'acheteurs 
```yaml
action_id: eci_3.2.3
```
## Description
