<script lang="ts">
  ...
  import ToggleTheme from 'src.backup/lib/ToggleTheme.svelte'
  import Counter from 'src.backup/lib/Counter.svelte'
  import Timer from 'src.backup/lib/Timer.svelte'
</script>
