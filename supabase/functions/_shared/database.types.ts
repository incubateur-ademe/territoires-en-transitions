		...
		Tables: {
			...
			action_impact: {
				...
				Relationships: [
					...
					{
						foreignKeyName: 'action_impact_niveau_complexite_fkey';
						columns: ['niveau_complexite'];
						referencedRelation: 'action_impact_complexite';
						referencedColumns: ['niveau'];
					}
				];
			};
			...
			indicateur_definition: {
				Row: {
					...
					cherchable: string | null;
					enfants: unknown | null;
				};
				Insert: {
					description: string;
					id: string;
			...
			indicateur_service_tag: {
				...
				Relationships: [
					...
					{
						foreignKeyName: 'indicateur_service_tag_indicateur_personnalise_definition_id_fk';
						columns: ['indicateur_perso_id'];
						referencedRelation: 'indicateur_personnalise_definition';
						referencedColumns: ['id'];
					},
