 ...
 */
export const fetchData = async (supabaseClient: TSupabaseClient, collectivite_id: number) => {
    return {
 ...
 */
export const fetchThematiques = async (supabaseClient: TSupabaseClient)
    : Promise<Map<string, Database["public"]["Tables"]["thematique"]["Insert"]>> => {
    ...
    const toReturn = new Map<string, Database["public"]["Tables"]["thematique"]["Insert"]>();
    for(let i=0; i<data.length; i++){
        const thematique : Database["public"]["Tables"]["thematique"]["Insert"] = data[i];
...
export const fetchSousThematiques = async (
    ...
    const toReturn = new Map<string, Database["public"]["Tables"]["sous_thematique"]["Insert"]>();
    for(let i=0; i<data.length; i++){
        const sousThematique : Database["public"]["Tables"]["sous_thematique"]["Insert"] = data[i];
 ...
 */
export const fetchActions = async (supabaseClient: TSupabaseClient) :
    Promise<Map<string, Database["public"]["Tables"]["action_relation"]["Insert"]>> =>
{
    const query = supabaseClient
    ...
    const toReturn = new Map<string, Database["public"]["Tables"]["action_relation"]["Insert"]>();
    for(let i=0; i<data.length; i++){
        const action : Database["public"]["Tables"]["action_relation"]["Insert"] = data[i];
 ...
 */
export const fetchPersonnes = async (supabaseClient: TSupabaseClient, collectivite_id : number) :
 ...
 */
export const fetchFiches= async (supabaseClient: TSupabaseClient, collectivite_id : number) :
