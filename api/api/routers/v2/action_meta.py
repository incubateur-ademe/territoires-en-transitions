...
from api.models.tortoise.action_meta import (
    ActionMeta_Pydantic,
    ActionMeta,
    ActionMetaIn_Pydantic,
)
...
@router.get(
    "/{epci_id}/{action_id}",
    response_model=ActionMeta_Pydantic,
...
async def get_action_meta(epci_id: str, action_id: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=404, detail=f"Action_meta {epci_id}/{action_id} not found"
        )
