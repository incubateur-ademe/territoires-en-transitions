...
async def get_indicateur_personnalise_yearly_values(epci_id: str, indicateur_id: str):
    filter_query = IndicateurPersonnaliseValue.filter(epci_id=epci_id, indicateur_id=indicateur_id, latest=True)
...
async def get_indicateur_personnalise_value(epci_id: str, indicateur_id: str, year: int):
    query = IndicateurPersonnaliseValue.get(epci_id=epci_id, indicateur_id=indicateur_id, year=year, latest=True)
    try:
