...
from api.models.tortoise.indicateur_personnalise import (
    IndicateurPersonnalise_Pydantic,
...
async def get_indicateur_personnalise(epci_id: str, uid: str):
    query = IndicateurPersonnalise.get(
    ...
    try:
        ...
        raise HTTPException(
            status_code=404, detail=f"Indicateur_personnalise {epci_id}/{uid} not found"
        )
