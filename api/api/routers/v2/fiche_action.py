...
from api.models.tortoise.fiche_action import (
    FicheAction_Pydantic,
    FicheAction,
    FicheActionIn_Pydantic,
)
...
@router.get(
    "/{epci_id}/{uid}",
    response_model=FicheAction_Pydantic,
...
async def get_fiche_action(epci_id: str, uid: str):
    ...
    try:
        ...
        raise HTTPException(
            status_code=404, detail=f"fiche_action {epci_id}/{uid} not found"
        )
