...
from api.models.tortoise.indicateur_value import (
    IndicateurValue_Pydantic,
    IndicateurValue,
    IndicateurValueIn_Pydantic,
)
...
async def get_indicateur_yearly_values(epci_id: str, indicateur_id: str):
    filter_query = IndicateurValue.filter(
