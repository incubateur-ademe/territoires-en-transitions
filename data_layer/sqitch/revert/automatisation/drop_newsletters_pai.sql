-- Revert tet:automatisation/drop_newsletters_pai from pg

BEGIN;

-- La ligne 'send_user_pai_to_brevo' de automatisation.supabase_function_url n'est
-- pas restaurée : url et api_key sont propres à chaque environnement et n'ont
-- jamais été versionnées ici.
