-- Revert tet:taxonomie/thematique from pg
...
set thematique = (select thematique from thematique t where t.id = fat.thematique_id limit 1);
...
alter table thematique
    add constraint thematique_pkey
        primary key (thematique);

create table indicateur_thematique_nom
(
    id  indicateur_thematique not null
        primary key,
    nom text                  not null
);
...
create function filter_fiches_action(
    ...
    sous_thematiques sous_thematique[] DEFAULT NULL::sous_thematique[],
