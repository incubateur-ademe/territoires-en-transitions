...
where md_id = 'agriculture_alimentation';

alter table thematique alter column md_id type old_indicateur_thematique using md_id::old_indicateur_thematique;
...
-- revert function pour enlever le cast
