...
(
    ...
    annexe_id integer not null references annexe,
...
from fiche_action fa
    ...
    -- annexes
         left join (select faa.fiche_id, array_agg(a.*) AS annexes
                    from annexe a
...
create function ajouter_annexe(fiche_id integer, annexe annexe) returns annexe
    language plpgsql
as
$$
declare
