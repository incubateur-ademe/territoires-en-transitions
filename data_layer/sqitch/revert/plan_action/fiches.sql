...
-- ajouter_action
    alter function private.ajouter_action set schema public;
-- ajouter_financeur
    alter function private.ajouter_financeur set schema public;
-- ajouter_indicateur
    alter function private.ajouter_indicateur set schema public;
-- ajouter_partenaire
    alter function private.ajouter_partenaire set schema public;
-- ajouter_pilote
    alter function private.ajouter_pilote set schema public;
-- ajouter_referent
    alter function private.ajouter_referent set schema public;
-- ajouter_service
    alter function private.ajouter_service set schema public;
-- ajouter_sous_thematique
    alter function private.ajouter_sous_thematique set schema public;
-- ajouter_structure
    alter function private.ajouter_structure set schema public;
-- ajouter_thematique
    alter function private.ajouter_thematique set schema public;
-- enlever_action
    alter function private.enlever_action set schema public;
-- enlever_indicateur
    alter function private.enlever_indicateur set schema public;
-- enlever_partenaire
    alter function private.enlever_partenaire set schema public;
-- enlever_pilote
    alter function private.enlever_pilote set schema public;
-- enlever_referent
    alter function private.enlever_referent set schema public;
-- enlever_service
    alter function private.enlever_service set schema public;
-- enlever_sous_thematique
    alter function private.enlever_sous_thematique set schema public;
-- enlever_structure
    alter function private.enlever_structure set schema public;
-- enlever_thematique
    alter function private.enlever_thematique set schema public;
