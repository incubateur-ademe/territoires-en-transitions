-- Deploy tet:indicateur/change_unite_emission_ges to pg
...
resultat = case 
	...
	else ROUND((resultat/1000)::numeric,3)
end,
objectif  = case 
	when objectif is null then null 
	else ROUND((objectif/1000)::numeric,3)
end
...
and (indicateur_valeur.collectivite_id not in (3881, 5096) or indicateur_valeur.metadonnee_id is not null))
