...
create function private.indicateur_personnalise_collectivite_id(indicateur_id integer) returns integer as
$$
...
comment on function private.indicateur_personnalise_collectivite_id
    is 'Retourne la collectivité d''un indicateur à partir de son id';
...
alter table indicateur_personnalise_pilote enable row level security;
...
alter table indicateur_personnalise_service_tag enable row level security;
