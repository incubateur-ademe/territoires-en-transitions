...
create index fiche_action_axe_fiche_id_index
    on fiche_action_axe (fiche_id);

create index axe_collectivite_id_index
    on axe (collectivite_id);

create index axe_collectivite_id_id_index
    on axe (collectivite_id, id);

create index axe_parent_id_index
    on axe (parent, id);

create index axe_parent_index
    on axe (parent);

create or replace function plan_action_tableau_de_bord(
