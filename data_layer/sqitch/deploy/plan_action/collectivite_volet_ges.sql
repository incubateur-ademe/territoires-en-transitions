...
COMMENT ON TABLE public.collectivite_volet_ges IS
  'Mobilisation d''une collectivite sur chaque volet, notee de 0 a 3. La grille est complete : 174 lignes, zeros compris. Une case a 0 vaut evaluee et sans action, une case absente vaut jamais evaluee.';
