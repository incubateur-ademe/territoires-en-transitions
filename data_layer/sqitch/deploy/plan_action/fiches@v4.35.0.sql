...
--
-- BEFORE. Drop related functions and views to recreate `fiches_action` views with the new fields
...
--
-- Recreate the view with the new field `modifiedBy`
...
SELECT fa.modified_at,
       ...
       -- ↓ CHANGES HERE ↓
       CASE
          WHEN fa.modified_by IS NULL THEN NULL
