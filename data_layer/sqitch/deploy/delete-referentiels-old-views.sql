...
DROP materialized view IF EXISTS stats.collectivite_referentiel;
DROP function IF EXISTS collectivite_card(axe);
DROP materialized view IF EXISTS collectivite_card;
