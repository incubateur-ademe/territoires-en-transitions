...
select v.nom, v.type, v.region_code, v.siren, v.nic
from (values
        ('Direction Régionale Guadeloupe', 'dr_ademe', '01', '385290309', '00389'),
        ('Direction Régionale Martinique', 'dr_ademe', '02', '385290309', '00595'),
        ('Direction Régionale Guyane', 'dr_ademe', '03', '385290309', '00538'),
        ('Direction Régionale Océan Indien', 'dr_ademe', '04', '385290309', '00397'),
        ('Direction Régionale Océan Indien', 'dr_ademe', '06', '385290309', '00397'),
        ('Direction Régionale Île-de-France', 'dr_ademe', '11', '385290309', '00199'),
        ('Direction Régionale Centre-Val de Loire', 'dr_ademe', '24', '385290309', '00579'),
        ('Direction Régionale Bourgogne-Franche-Comté', 'dr_ademe', '27', '385290309', '00520'),
        ('Direction Régionale Normandie', 'dr_ademe', '28', '385290309', '00314'),
        ('Direction Régionale Hauts-de-France', 'dr_ademe', '32', '385290309', '00561'),
        ('Direction Régionale Grand Est', 'dr_ademe', '44', '385290309', '00611'),
        ('Direction Régionale Pays de la Loire', 'dr_ademe', '52', '385290309', '00686'),
        ('Direction Régionale Bretagne', 'dr_ademe', '53', '385290309', '00546'),
        ('Direction Régionale Nouvelle-Aquitaine', 'dr_ademe', '75', '385290309', '00496'),
        ('Direction Régionale Occitanie', 'dr_ademe', '76', '385290309', '00603'),
        ('Direction Régionale Auvergne-Rhône-Alpes', 'dr_ademe', '84', '385290309', '00371'),
        ('Direction Régionale Provence-Alpes-Côte d''Azur', 'dr_ademe', '93', '385290309', '00629'),
        ('Direction Régionale Corse', 'dr_ademe', '94', '385290309', '00504')
) as v (nom, type, region_code, siren, nic)
where exists (select 1 from collectivite)
