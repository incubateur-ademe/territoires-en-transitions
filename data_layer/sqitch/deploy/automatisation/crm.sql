...
-- Lignes modifiées :
-- 1. colonne modifiée `pa_pilotables`
-- 2. colonne modifiée `fiches_pilotables`
-- 3. colonne ajoutée `pa_view_2_mois` (remplace `pa_view_1_mois` et `pa_view_3_mois`)
-- 3. colonne modifiée`pa_view_6_mois`
-- 4. colonne ajoutée `pai` 
-- 5. colonne ajoutée `fiches_pai`
-- 6. colonne modifiée `type_pa`
