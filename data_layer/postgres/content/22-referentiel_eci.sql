...
', 15.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.2.0', 'eci', '2.2.0', 'Respecter la réglementation', 'La gestion de la collecte des déchets est conforme à la réglementation.
...
', '', null, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.2.1', 'eci', '2.2.1', 'Connaitre l''état du service public de collecte des déchets', 'La collectivité a réalisé les études nécessaires en faveur d''une démarche d''optimisation du service public de collecte des déchets. Les études peuvent être réalisées en interne ou par un prestataire.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.2.2', 'eci', '2.2.2', 'Définir un plan d''action', 'Sur la base des données du suivi ou des résultats des études, la collectivité défini un plan d''actions d''optimisation de la collecte, en cohérence avec les objectifs de la loi relative à la lutte contre le gaspillage et pour l''économie circulaire (loi AGEC).
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.2.3', 'eci', '2.2.3', 'Mettre en œuvre le plan d''actions et communiquer', 'La collectivité met en œuvre le plan d''actions du Niveau 2. Elle pilote la mise en œuvre du plan d''actions pour s''assurer de l''atteinte des objectifs.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.3', 'eci', '2.3', 'Améliorer la valorisation des déchets (dont organiques)', 'La collectivité privilégie le respect de la hiérarchie des modes de traitement et tend vers des taux de recyclage et de valorisation de plus en plus élevés.
...
', 20.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.3.0', 'eci', '2.3.0', 'Respecter la règlementation', 'Les installations et équipements sont conformes à la réglementation (tous flux et tous modes de traitement).
...
', '', null, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.3.1', 'eci', '2.3.1', 'Connaitre les flux', 'En amont de l’optimisation de la valorisation des déchets sur son territoire, la collectivité doit :
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.3.2', 'eci', '2.3.2', 'Concrétiser les solutions issues des études d''optimisation', 'La collectivité concrétise les solutions issues des études d''optimisation. Elle met en place les conditions (financières et organisationnelles) pour favoriser l’émergence de ces solutions.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.3.3', 'eci', '2.3.3', 'Suivre et accompagner les installations de traitement', 'La collectivité suit les installations de traitement sous sa responsabilité et s’assure de leur efficacité en matière de valorisation. Dans cette optique, elle accompagne les équipes en charge de ces installations.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.4', 'eci', '2.4', 'Réduire les impacts environnementaux et sociaux de la gestion des déchets', 'La gestion des déchets génère des impacts environnementaux (liés notamment au transport...) et sociaux (pénibilité du travail, nuisances olfactives et sonores, ...) ; la réduction de ces impacts s’appuie respectivement sur l’optimisation des systèmes de transport ainsi que sur les diverses recommandations et guides des CARSAT (Caisses d’Assurance Retraite et de la Santé Au Travail).
...
', 20.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.4.1', 'eci', '2.4.1', 'Identifier les pistes de réduction des impacts', 'La collectivité étudie et priorise des pistes de réduction des émissions et nuisances.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.4.2', 'eci', '2.4.2', 'Gérer les impacts de la collecte des déchets', 'La collectivité a identifié les impacts de la collecte des déchets, a défini un plan d''actions pour les diminuer et le met en œuvre.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.4.3', 'eci', '2.4.3', 'Mettre en place le report modal de la collecte des déchets', 'La collectivité met en place un report modal de transport des déchets via un système de collecte autre que le système routier à moteur thermique.
...
', '', null, 10.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.4.4', 'eci', '2.4.4', 'Gérer les impacts du traitement des déchets', 'La collectivité identifie les impacts du traitement. Elle définit un plan d''actions pour les diminuer et le met en œuvre.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.4.5', 'eci', '2.4.5', 'Communiquer sur les impacts', 'La collectivité communique sur ses données d''impacts environnementaux et sociaux
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.5', 'eci', '2.5', 'Créer du lien avec les acteurs économiques du territoire pour créer des dynamiques sur leurs déchets', 'La mobilisation des acteurs économiques (entreprises industrielles et du BTP, artisans et commerçants, services tertiaires…) est indispensable pour améliorer la prévention et la gestion des déchets sur un territoire en raison des quantités et de la nature des déchets qu’ils produisent.
...
', 15.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.5.1', 'eci', '2.5.1', 'Informer les professionnels', 'La collectivité oriente les professionnels bénéficiant du SPPGD et leur propose l''ensemble des solutions de gestion de leurs déchets disponibles sur le territoire, y compris si ces solutions sont hors de leur périmètre SPPGD (renvoi vers les solutions privées)
...
', '', null, 25.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.5.2', 'eci', '2.5.2', 'Conseiller les professionnels', 'La collectivité propose un service de conseil aux entreprises, collectif et/ou individuel, pour les aider à   réduire les déchets, mieux les trier et maîtriser les coûts associés.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.5.3', 'eci', '2.5.3', 'Structurer et mettre en réseau les acteurs', 'La collectivité joue un rôle de facilitateur et un rôle moteur auprès des entreprises dans l''implantation ou la consolidation de services de prévention et de gestion des déchets, adaptés aux besoins du territoire et, quand c''est possible, en lien avec le service développement économique.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.1', 'eci', '2.1', 'Disposer d''un programme de prévention des déchets', 'Le Programme Local de Prévention des Déchets Ménagers et Assimilés (PLPDMA) d''un territoire vise à réduire la quantité et la nocivité des déchets (via l''atteinte d''un objectif partagé). Ce programme s''inscrit dans la durée au travers de la coordination, de la mise en place et du suivi d''actions concertées avec les acteurs locaux.
...
', 10.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.1.0', 'eci', '2.1.0', 'Suivre la réglementation', 'La collectivité est conforme à la réglementation
...
', '', null, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.1.1', 'eci', '2.1.1', 'Mettre en œuvre les actions du PLPDMA', 'Les actions prévues dans le PLPDMA sont mises en œuvre
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_2.1.3', 'eci', '2.1.3', 'Suivre le PLPDMA', 'La collectivité assure suivi la démarche, dresse des bilans des actions et ajuste le programme d''actions selon les résultats
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.7', 'eci', '3.7', 'Soutenir et accompagner la recherche, l''innovation et l''expérimentation', 'La collectivité soutient des projets de recherche et d''innovation (R&I), tant sur le volet technologique qu''organisationnel afin de promouvoir les pratiques d''économie circulaire (hors 3.4 à 3.7).
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.3.2', 'eci', '3.3.2', 'Promouvoir et lancer une dynamique relative à la consommation responsable et de sobriété', 'La collectivité sensibilise et forme à la consommation responsable et la sobriété ses élus et ses techniciens.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.3.3', 'eci', '3.3.3', 'Agir pour la consommation responsable et la sobriété dans le cadre de ses compétences', 'La collectivité met en place des actions de consommation responsable et de sobriété sur ses compétences (écoles, garderies, espaces verts, gestion des déchets …)
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.3.4', 'eci', '3.3.4', 'Accompagner les acteurs externes sur des actions de consommation responsable et de sobriété', 'La collectivité accompagne les acteurs de son territoire sur des actions de consommation responsable et de sobriété. Elle aide au changement de comportement et favorise le développement d’une offre sobre.
...
', 25.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.2.0', 'eci', '3.2.0', 'Mettre en place le Schéma de promotion des achats publics socialement et écologiquement responsables (SPASER)', 'Si la collectivité gère un montant annuel d''achats supérieur à 100 millions d''euros, elle est dans l''obligation d''avoir mis en place un Schéma de promotion des achats publics socialement et écologiquement responsables (SPASER).
...
', '', null, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.2.1', 'eci', '3.2.1', 'Définir la politique d''achats responsables et sensibiliser', 'La collectivité définit le cadre et formalise sa politique d''achats responsables dans un document écrit.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.2.3', 'eci', '3.2.3', 'Pérenniser la démarche', 'Le service Achats met en place les outils nécessaires à la pérennisation de la démarche : la démarche est systématisée à l''ensemble des marchés passés par la collectivité dans une logique d''amélioration continue, une veille sur les caractéristiques environnementales, sociales et de l''économie circulaire de l''offre est assurée, le pilotage de ses achats (mise en place d''indicateurs, d''un tableau de bord de suivi des progrès) est réalisé.
...
', 25.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.6.1', 'eci', '3.6.1', 'Sensibiliser et former', 'La collectivité forme les élus et son personnel à l’économie de la fonctionnalité et de la coopération en lien avec la transition écologique et sociale de son territoire.
...
', 35.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.1.1', 'eci', '3.1.1', 'Réaliser le diagnostic des filière(s) à enjeux d''économie circulaire', 'A l''appui de la stratégie adoptée dans l''orientation 1.1, la collectivité approfondit le diagnostic sur les secteurs économiques analysés sous l''angle de l''économie circulaire.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.1.2', 'eci', '3.1.2', 'Construire un plan d''action spécifique', 'La collectivité construit son plan d''actions spécifique autour d''au moins une filière à enjeu sur son territoire. Elle consulte les acteurs clés de la filière et définit les partenariats associés au plan d''action. Les partenariats sont précisés dans l''Axe 5 du Référentiel.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.1.3', 'eci', '3.1.3', 'Piloter et suivre les résultats du plan d''actions', 'La collectivité met en œuvre un suivi du (des) plan(s) d''action spécifique(s) par filière en y associant les acteurs impliqués dans sa réalisation.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.5', 'eci', '3.5', 'Soutenir et accompagner les projets d''Ecologie Industrielle et Territoriale (EIT)', 'L''EIT s''appuie sur l''étude des flux  pour identifier et développer des synergies entre acteurs économiques d’un territoire :  substituer des flux de matières, d''énergies et d''eau, initier la mutualisation de moyens et de services, le partage d''infrastructures.
...
', 25.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.5.1', 'eci', '3.5.1', 'Elaborer la stratégie et structurer en interne', 'Conjointement avec les services Développement économique et Environnement (déchets, économie circulaire, climat, énergie, etc.), la collectivité élabore un document formalisant sa stratégie EIT (politique, feuille de route, etc.).
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.5.3', 'eci', '3.5.3', 'Accompagner opérationnellement les projets', 'La collectivité a attribué un financement pluriannuel à la démarche d''EIT ou a internalisé un poste d''animateur(trice) en charge de l''accompagnement des projets d''EIT du territoire.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.5.4', 'eci', '3.5.4', 'Pérenniser et partager les expériences', 'La collectivité impulse et/ou pilote la création ou le transfert du pilotage de la démarche d''EIT à une structure externe dédiée (acteur-tiers) dont la gouvernance est multi-acteurs. Si la structure existe déjà, elle participe à sa consolidation. Elle participe aux instances de gouvernance auprès des autres acteurs partenaires (entreprises, associations, etc.).
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.4', 'eci', '3.4', 'Soutenir et accompagner l''écoconception des produits transformés et des services du territoire', 'L''écoconception vise, dès la conception d''un procédé, d''un bien ou d''un service, à prendre en compte l''ensemble du cycle de vie en minimisant les impacts environnementaux.
...
', 25.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.4.1', 'eci', '3.4.1', 'Animer le réseau', 'La collectivité anime (elle-même ou en partenariat avec la Région, les chambres consulaires, les associations environnementales, …) ou participe à l''animation d''un réseau d''entreprises, afin d''impulser une dynamique d''engagement de celles-ci dans les démarches d''éco-conception ou d''éco-innovation.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_3.4.4', 'eci', '3.4.4', 'Ecoconcevoir les projets à impacts', 'La collectivité encourage ou met en œuvre la prise en compte de l''ensemble du cycle de vie dans les études d''impacts de projets réalisés sur son territoire, au-delà des impacts locaux dus à son implantation.
...
', 20.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.2.1', 'eci', '4.2.1', 'Facturer des usagers non ménagers', 'La collectivité, si elle n''est pas en REOM, met en place la Redevance Spéciale pour les usagers non ménagers.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.2.2', 'eci', '4.2.2', 'Etudier le potentiel de mise en place de la Tarification incitative (Ti)', 'La collectivité étudie la mise en place d''un système de Ti (y compris redevance spéciale en cas de Taxe d’Enlèvement des Ordures Ménagères (TEOM) incitative) sur l''ensemble du territoire.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.2.3', 'eci', '4.2.3', 'Mettre en œuvre la Redevance Spéciale incitative pour les usagers non ménagers', 'La collectivité, si elle n''est pas en REOM, facture la Redevance Spéciale avec une part variable en fonction des levées et/ou pesées effectuées.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.2.4', 'eci', '4.2.4', 'Mettre en œuvre la Tarification incitative (Ti) pour tous les usagers', 'Au cas où l''étude sur la mise en place de la Ti est concluante, la collectivité met en place la Ti (y compris Redevance Spéciale en cas de TEOM incitative).
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.2.5', 'eci', '4.2.5', 'Mettre en place la Tarification incitative (Ti) du second niveau', 'Afin de récompenser les collectivités qui fournissent les efforts de prévention et de collecte sélective les plus significatifs, la collectivité en charge de traitement mets en place la Ti du second niveau.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.3', 'eci', '4.3', 'Promouvoir et mettre en place des outils financiers en faveur de l''économie circulaire à destination des autres acteurs du territoire', 'Les outils financiers constituent une voie de mobilisation des autres acteurs du territoire. La collectivité peut promouvoir les financements tiers et l''émergence de nouveaux modèles économiques.
...
', 20.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.3.1', 'eci', '4.3.1', 'Réaliser une veille', 'La collectivité s''informe sur les moyens de financements existants auprès des organismes qui agrègent déjà l''information dans le but de développer et porter des projets d''économie circulaire. Les acteurs relais possibles : agences de développement, CCI, réseaux, etc.

', '', 'Accompagnement financier de la Région, ADEME, BPI, CDC, financements européens, financement participatif, …

', '', null, 20.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.3.2', 'eci', '4.3.2', 'Communiquer sur les moyens de financement', 'La collectivité communique sur ces moyens de financement.
...
', '', null, 20.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.3.3', 'eci', '4.3.3', 'Accompagner les acteurs du territoire', 'La collectivité accompagne les acteurs de son territoire dans leur recherche de financements en faveur de l''économie circulaire en fonction de leurs besoins. Elle identifie, valorise et communique autour des démarches exemplaires du territoire.
...
', 20.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.1.0', 'eci', '4.1.0', 'Rédiger le rapport annuel SPPGD', 'La collectivité produit le rapport annuel du service public de prévention et de gestion des déchets ménagers et assimilés (SPPGD) qui répond aux exigences réglementaires en matière d''indicateurs techniques et économiques.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.1.1', 'eci', '4.1.1', 'Connaître la structure des coûts de la gestion des déchets', 'La collectivité réalise annuellement la matrice des coûts.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.1.2', 'eci', '4.1.2', 'Etudier les pistes d''optimisation', 'La collectivité analyse les résultats de la matrice afin d''identifier les pistes d''optimisation.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.1.3', 'eci', '4.1.3', 'Agir pour optimiser les dépenses publiques de gestion de déchets', 'Suite à l’étude d’optimisation désignée en 4.1.2., la collectivité met en œuvre des actions d''optimisation et évalue les résultats.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_4.1.4', 'eci', '4.1.4', 'Communiquer sur la démarche d''optimisation', 'La collectivité s''engage dans une communication transparente sur sa démarche d''optimisation des coûts de la gestion des déchets. Faire connaitre ces efforts d''optimisation est un levier de mobilisation des usagers pour la prévention des déchets et le changement de comportement.
...
', 30.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_1.1.1', 'eci', '1.1.1', 'S''engager politiquement et mettre en place des moyens', 'La collectivité justifie d''un portage politique de l''économie circulaire : un élu s’engage à travers l’établissement d’une politique Economie Circulaire.
...
', 30.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_1.3.1', 'eci', '1.3.1', 'Déterminer des indicateurs spécifiques dotés d''objectifs', 'Dans le cadre de sa stratégie, la collectivité détermine :
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_1.2', 'eci', '1.2', 'Développer une démarche transversale avec l''ensemble des politiques de la collectivité', 'Une démarche transversale au sein de la collectivité implique une participation de tous les services dans l''objectif commun de développer l''économie circulaire.
...
', 30.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_1.2.1', 'eci', '1.2.1', 'Former en interne', 'La collectivité répertorie les compétences nécessaires pour la mise en œuvre de la stratégie, du programme d''actions, ainsi que pour leur suivi.
...
', 30.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1', 'eci', '5.3.1', 'Informer et former les acteurs économiques', 'Dans une logique de sobriété, la collectivité met en place des actions de sensibilisation et de formations à l''attention des acteurs économiques sur les 7 piliers de l''économie circulaire.
...
', '', null, 20.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.1', 'eci', '5.3.1.1', 'Réaliser au moins 1 ou 2 actions sur le pilier approvisionnement durable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.2', 'eci', '5.3.1.2', 'Réaliser au moins 1 ou 2 actions sur le pilier éco-conception', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.3', 'eci', '5.3.1.3', 'Réaliser au moins 1 ou 2 actions sur le pilier écologie industrielle et territoriale (EIT)', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.4', 'eci', '5.3.1.4', 'Réaliser au moins 1 ou 2 actions sur le pilier économie de la fonctionnalité', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.5', 'eci', '5.3.1.5', 'Réaliser au moins 1 ou 2 actions sur le pilier consommation responsable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.6', 'eci', '5.3.1.6', 'Réaliser au moins 1 ou 2 actions sur le pilier allongement de la durée d''usage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.1.7', 'eci', '5.3.1.7', 'Réaliser au moins 1 ou 2 actions sur le pilier recyclage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2', 'eci', '5.3.2', 'Aider à l''action à destination des acteurs économiques', 'La collectivité met en place des actions concrètes avec les acteurs économiques de son territoire sur les 7 piliers de l''économie circulaire.
...
', '', null, 50.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2.1', 'eci', '5.3.2.1', 'Réaliser au moins 1 ou 2 actions sur le pilier approvisionnement durable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2.2', 'eci', '5.3.2.2', 'Réaliser au moins 1 ou 2 actions sur le pilier éco-conception', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.
...
', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2.4', 'eci', '5.3.2.4', 'Réaliser au moins 1 ou 2 actions sur le pilier économie de la fonctionnalité', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2.5', 'eci', '5.3.2.5', 'Réaliser au moins 1 ou 2 actions sur le pilier consommation responsable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2.6', 'eci', '5.3.2.6', 'Réaliser au moins 1 ou 2 actions sur le pilier allongement de la durée d''usage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.2.7', 'eci', '5.3.2.7', 'Réaliser au moins 1 ou 2 actions sur le pilier recyclage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.3.3', 'eci', '5.3.3', 'Fédérer les acteurs du territoire', 'La collectivité déploie des partenariats ayant aboutis à des actions avec les acteurs économiques de son territoire sur les 7 piliers de l''économie circulaire.
...
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2', 'eci', '5.2', 'Actions dirigées vers les autres collectivités du territoire', 'L''objectif est d''encourager la collectivité à déployer une politique d''actions économie circulaire vers les collectivités infra et supra et les EPCI qui interviennent sur son territoire sur l''ensemble des 7 piliers de l''économie circulaire.
...
', 30.0, null);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1', 'eci', '5.2.1', 'Informer, sensibiliser et former les autres collectivités et EPCI de son territoire', 'Dans une logique de sobriété, la collectivité informe, sensibilise et forme les autres collectivités et EPCI de son territoire sur les 7 piliers de l''économie circulaire
...
', '', null, 20.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1.1', 'eci', '5.2.1.1', 'Réaliser au moins 1 ou 2 actions sur le pilier approvisionnement durable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1.2', 'eci', '5.2.1.2', 'Réaliser au moins 1 ou 2 actions sur le pilier éco-conception', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.
...
', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1.4', 'eci', '5.2.1.4', 'Réaliser au moins 1 ou 2 actions sur le pilier économie de la fonctionnalité', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1.5', 'eci', '5.2.1.5', 'Réaliser au moins 1 ou 2 actions sur le pilier consommation responsable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1.6', 'eci', '5.2.1.6', 'Réaliser au moins 1 ou 2 actions sur le pilier allongement de la durée d''usage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.1.7', 'eci', '5.2.1.7', 'Réaliser au moins 1 ou 2 actions sur le pilier recyclage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2', 'eci', '5.2.2', 'Aider à l''action des autres collectivités et EPCI de son territoire', 'La collectivité soutient des actions concrètes réalisées en direction des autres EPCI sur les 7 piliers de l''économie circulaire.
...
', '', null, 40.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2.1', 'eci', '5.2.2.1', 'Réaliser au moins 1 ou 2 actions sur le pilier approvisionnement durable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2.2', 'eci', '5.2.2.2', 'Réaliser au moins 1 ou 2 actions sur le pilier éco-conception', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.
...
', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2.4', 'eci', '5.2.2.4', 'Réaliser au moins 1 ou 2 actions sur le pilier économie de la fonctionnalité', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2.5', 'eci', '5.2.2.5', 'Réaliser au moins 1 ou 2 actions sur le pilier consommation responsable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2.6', 'eci', '5.2.2.6', 'Réaliser au moins 1 ou 2 actions sur le pilier allongement de la durée d''usage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.2.7', 'eci', '5.2.2.7', 'Réaliser au moins 1 ou 2 actions sur le pilier recyclage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.2.3', 'eci', '5.2.3', 'Structurer des partenariats', 'La collectivité structure des partenariats avec les EPCI pour généraliser et amplifier la démarche sur l''ensemble du territoire.
...
', '', null, 20.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.1.1', 'eci', '5.1.1.1', 'Réaliser au moins 1 ou 2 actions sur le pilier approvisionnement durable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.1.2', 'eci', '5.1.1.2', 'Réaliser au moins 1 ou 2 actions sur le pilier éco-conception', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.
...
', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.1.4', 'eci', '5.1.1.4', 'Réaliser au moins 1 ou 2 actions sur le pilier économie de la fonctionnalité', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.1.5', 'eci', '5.1.1.5', 'Réaliser au moins 1 ou 2 actions sur le pilier consommation responsable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.1.6', 'eci', '5.1.1.6', 'Réaliser au moins 1 ou 2 actions sur le pilier allongement de la durée d''usage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.1.7', 'eci', '5.1.1.7', 'Réaliser au moins 1 ou 2 actions sur le pilier recyclage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2', 'eci', '5.1.2', 'Aider à l''action en direction du grand public', 'La collectivité soutient des actions concrètes réalisées en direction du grand public sur les 7 piliers de l''économie circulaire en s''appuyant sur les initiatives du territoire.
...
', '', null, 40.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2.1', 'eci', '5.1.2.1', 'Réaliser au moins 1 ou 2 actions sur le pilier approvisionnement durable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2.2', 'eci', '5.1.2.2', 'Réaliser au moins 1 ou 2 actions sur le pilier éco-conception', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.
...
', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2.4', 'eci', '5.1.2.4', 'Réaliser au moins 1 ou 2 actions sur le pilier économie de la fonctionnalité', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2.5', 'eci', '5.1.2.5', 'Réaliser au moins 1 ou 2 actions sur le pilier consommation responsable', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 14.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2.6', 'eci', '5.1.2.6', 'Réaliser au moins 1 ou 2 actions sur le pilier allongement de la durée d''usage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.2.7', 'eci', '5.1.2.7', 'Réaliser au moins 1 ou 2 actions sur le pilier recyclage', 'Au moins 1 action pour les collectivités avec une population inférieure à 100 000 habitants. Au moins 2 actions pour les collectivités avec une population supérieure à 100 000 habitants.

', '', '', '', null, 15.0);
insert into action_definition(action_id, referentiel, identifiant, nom, description, contexte, exemples, ressources, points, pourcentage) values ('eci_5.1.3', 'eci', '5.1.3', 'Fédérer les acteurs du territoire', 'La collectivité crée des espaces communs de dialogue afin d''encourager et amplifier les actions sur le territoire. Elle structure des partenariats avec les associations (et autres acteurs) sur les 7 piliers de l''économie circulaire. Elle mesure la réussite des partenariats mis en place et valorise les résultats.
