...
values  ('tourisme_1', 'tourisme', null, '{commune}', 'proportion', '', 'Quelle est la part de la collectivité dans la structure compétente en matière de tourisme ?'),
        ...
        ('SPASER', 'achats_responsables', null, null, 'binaire', '', 'Le montant annuel des achats publics de la collectivité est-il inférieur à 100 000 000 € hors-taxes ?'),
        ('formation', 'formation', null, null, 'binaire', '', 'Existe-t-il des établissements de formation initiale et continue sur le territoire ?'),
        ('scolaire_1', 'formation', null, null, 'binaire', '', 'La collectivité est-elle en charge des équipements de l''enseignement pré-élementaire et élémentaire et/ou des activités périscolaires ?'),
        ('scolaire_2', 'formation', null, null, 'binaire', '', 'Des établissements scolaires et/ou des structure d’accueil de jeunes enfants sont-ils présents sur le territoire ?'),
        ('SAU', 'agri_alim', null, null, 'binaire', '', 'La collectivité possède-t''elle moins de 3 % de surfaces agricoles ?'),
        ('foret', 'foret', null, null, 'binaire', '', 'La collectivité possède-t''elle moins de 10 % de surfaces forestières (publiques ou privées) ?'),
        ('centre_polarite', 'centre_polarite', null, null, 'binaire', '', 'La collectivité possède-t-elle des centres-bourgs (dans le cas d''une commune) ou des communes (dans le cas d''un EPCI) de plus de 2 000 habitants ?'),
        ...
        ('SCoT', 'urbanisme_habitat', null, null, 'binaire', '', 'La collectivité a-t-elle la compétence "Schéma de Cohérence Territoriale" (SCoT) ?'),
        ('urba_2', 'urbanisme_habitat', null, null, 'binaire', '', 'La collectivité a-t-elle la compétence d''instruction des permis de construire ?'),
        ('urba_3', 'urbanisme_habitat', null, null, 'binaire', '', 'La collectivité a-t-elle la compétence d''octroi des permis de construire ?'),
        ('habitat_1', 'urbanisme_habitat', null, null, 'binaire', '', 'La collectivité a-t-elle la compétence habitat ?'),
        ...
        ('dev_eco_1', 'developpement_economique', null, null, 'binaire', '', 'La collectivité a-t-elle la compétence développement économique ?'),
        ...
        ('dechets_1', 'dechets', null, null, 'binaire', '', 'La collectivité a-t-elle la compétence collecte des déchets ?'),
