...
insert into collectivite (nom, type) values ('testsql', 'test');
select ok((select count(*) = 1 from collectivite where nom = 'testsql'));

-- Ajout données
insert into action_commentaire(collectivite_id, action_id, commentaire, modified_by)
values ((select id from collectivite where nom = 'testsql' limit 1), 'eci_2.1', 'commentaire', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
-- action_statut
...
values ((select id from collectivite where nom = 'testsql' limit 1), null, '', 'eci_2.1', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
...
values ((select id from collectivite where nom = 'testsql' limit 1), null, '', now(), '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
...
values ((select id from collectivite where nom = 'testsql' limit 1), null, '', 'CEP', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
...
where cb.collectivite_id = (select id from collectivite where nom = 'testsql' limit 1);
insert into storage.objects (bucket_id, name, owner, metadata)
select bucket_id,
...
values ((select id from collectivite where nom = 'testsql' limit 1),
        'e9df071601f3f72b5430a55cd7ea584be5c2a36bb4226b621c4dca50088ef8b9',
        'yo.pdf');
...
values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1), 'eci_2.1', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
-- action_discussion_commentaire
insert into action_discussion_commentaire(id, discussion_id, message, created_by)
values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1), 'commentaire', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');

-- INDICATEUR --
-- indicateur_resultat
-- TODO à changer
/*insert into indicateur_resultat(modified_at, valeur, annee, collectivite_id, indicateur_id)
values (now(), 1.0, 2020, (select id from collectivite where nom = 'testsql' limit 1), 'eci_5');
-- indicateur_objectif
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'eci_5', 2020, 'test', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9', now());
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'eci_5', 'test', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9', now());
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'eci_5', 2020, 1.0, 'source', 'cerema', now());
...
values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1), 'titre', 'description', 'unite', 'commentaire', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9'),
       ((select id from collectivite where nom = 'testsql' limit 1)*10, (select id from collectivite where nom = 'testsql' limit 1), 'titre', 'description', 'unite', 'commentaire', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
...
values (now(), 1.0, 2020, (select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1));
...
values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1), 2020, 'test', '17440546-f389-4d4f-bfdb-b0c94a1bd0f9', now());
...
values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10, (select id from collectivite where nom = 'testsql' limit 1)),
       -- fiche_action -> fiche_une
       ((select id from collectivite where nom = 'testsql' limit 1)*10+1, (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10+3, (select id from collectivite where nom = 'testsql' limit 1)),
       -- fiche_action -> fiche_deux
       ((select id from collectivite where nom = 'testsql' limit 1)*10+2, (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10+4, (select id from collectivite where nom = 'testsql' limit 1));
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'financeur', (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10, 'financeur_', (select id from collectivite where nom = 'testsql' limit 1));
-- fiche_action_financeur_tag
insert into fiche_action_financeur_tag(fiche_id, financeur_tag_id, montant_ttc) values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1), 100);
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'partenaire', (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10, 'partenaire_', (select id from collectivite where nom = 'testsql' limit 1));
-- fiche_action_partenaire_tag
insert into fiche_action_partenaire_tag (fiche_id, partenaire_tag_id) values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1));
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'service', (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10, 'service_', (select id from collectivite where nom = 'testsql' limit 1));
-- fiche_action_service_tag
insert into fiche_action_service_tag (fiche_id, service_tag_id) values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1));
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'structure', (select id from collectivite where nom = 'testsql' limit 1)),
       ((select id from collectivite where nom = 'testsql' limit 1)*10, 'structure_', (select id from collectivite where nom = 'testsql' limit 1));
-- fiche_action_structure_tag
insert into fiche_action_structure_tag (fiche_id, structure_tag_id) values ((select id from collectivite where nom = 'testsql' limit 1), (select id from collectivite where nom = 'testsql' limit 1));
...
-- fiche_action_action
insert into fiche_action_action (fiche_id, action_id) values((select id from collectivite where nom = 'testsql' limit 1), 'eci_2.1');
-- fiche_action_indicateur
--insert into fiche_action_indicateur(fiche_id, indicateur_id, indicateur_personnalise_id)
--values ((select id from collectivite where nom = 'testsql' limit 1), null, (select id from collectivite where nom = 'testsql' limit 1));
-- fiche_action_lien
...
-- reponse_choix
insert into reponse_choix(collectivite_id, question_id, reponse) values ((select id from collectivite where nom = 'testsql' limit 1), 'EP_1', 'EP_1_b');
-- reponse_proportion
insert into reponse_proportion(collectivite_id, question_id, reponse) values ((select id from collectivite where nom = 'testsql' limit 1), 'habitat_2', 1.0);
-- justification
...
values ((select id from collectivite where nom = 'testsql' limit 1), 'dechets_1', 'texte', now(), '17440546-f389-4d4f-bfdb-b0c94a1bd0f9');
alter table justification enable trigger modified_by;

insert into cot(collectivite_id, actif, signataire)
values ((select id from collectivite where nom = 'testsql' limit 1), true, null);

-- Suppression collectivité test
select test.identify_as_service_role();
select delete_collectivite_test((
    select id from collectivite where nom = 'testsql' limit 1
));
