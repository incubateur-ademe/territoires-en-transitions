...
values  
        -- ECI 1ère étoile
        ('1', 1, 'eci', 'eci_1.1.1.1', 'Identifier un⸱e élu⸱e référent⸱e', 100, null),
        ('1', 2, 'eci', 'eci_1.1.1.3', 'Identifier une personne technique', 100, null),
        ('1', 3, 'eci', 'eci_1.1.3.1', 'Mettre en place une équipe projet', 100, 100),
