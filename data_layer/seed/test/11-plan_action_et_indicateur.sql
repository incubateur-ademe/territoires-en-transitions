...
create table test.personne_tag as select id, nom, collectivite_id from public.personne_tag;
...
truncate public.personne_tag cascade;
insert into public.personne_tag (id, nom, collectivite_id) select id, nom, collectivite_id from test.personne_tag;
