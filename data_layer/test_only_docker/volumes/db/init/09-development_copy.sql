...
with active_collectivite as 
    (select distinct collectivite.id as collectivite_id
        from collectivite
...
owned_id as 
(
  select collectivite_id, nom from owned_collectivite
)
select active_collectivite.collectivite_id from active_collectivite 
left join owned_collectivite on owned_collectivite.collectivite_id = active_collectivite.collectivite_id 
