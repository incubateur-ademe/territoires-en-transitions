...
const chartTitle = { textAlign: 'center', display: 'block'};
  ...
  return <div className="fr-container-fluid">
    ...
    <section className="fr-container">
      ...
      <p>Territoires en Transitions est une plateforme publique gratuite et
        ...
        écologique.</p>
      <h2 style={display}>Déployer la transition écologique sur la totalité du
        territoire
        national</h2>
      ...
      <h6 style={chartHead}>Progression de l’activation des EPCI sur le territoire national</h6>
      <div className="fr-grid-row fr-grid-row--center">
        <div className="fr-col-4 fr-ratio-1x1">
          <em style={chartTitle}>Nombre EPCI actives</em>
          <CarteEpciParDepartement valeur={'actives'} maximum={'actives_max'} />
        </div>
        <div className="fr-col-4 fr-ratio-1x1">
          <em style={chartTitle}>Pourcentage EPCI actives</em>
          <CarteEpciParDepartement valeur={'ratio'} maximum={'ratio_max'} />
        </div>
        <div className="fr-col-4 fr-ratio-1x1">
          <em style={chartTitle}>Adoption globale</em>
    ...
    <section className="fr-container">
      <h2 style={display}>Outiller les personnes chargées de la planification
        écologique</h2>
    ...
    <section className="fr-container">
      ...
      <h6 style={chartHead}>
        États des lieux réalisés ventilés par taux de progression</h6>
      <div className="fr-grid-row fr-grid-row--center fr-grid-row--gutters">
        <div className="fr-col-5 fr-ratio-1x1">
          <em style={chartTitle}>
            Économie circulaire</em>
          <TrancheCompletude referentiel="eci" />
        </div>
        <div className="fr-col-5 fr-ratio-1x1">
          <em style={chartTitle}>
            Climat Air Énergie</em>
    ...
    <section className="fr-container">
      <h2 style={display}>
        Planifier et prioriser les actions en faveur de la transition écologique
      </h2>
    ...
    <section className="fr-container">
      <h2 style={display}>Suivre les indicateurs clés de réalisation et d’impact
        de la
        transition
        écologique</h2>
    ...
    <section className="fr-container">
      <h2 style={display}>Partager et valoriser la progression de chaque
        territoire</h2>
