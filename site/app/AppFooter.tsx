    ...
    <div className="fr-container">
          ...
          <ul className="fr-footer__content-list">
            <li className="fr-footer__content-item">
              <a
                ...
                rel="noreferrer">ademe.fr</a></li>
            <li className="fr-footer__content-item">
              <a
                className="fr-footer__content-link" target="_blank"
                href="https://gouvernement.fr"
                rel="noreferrer">beta.gouv</a></li>
            <li className="fr-footer__content-item">
              <a
                className="fr-footer__content-link" target="_blank"
      ...
      <div className="fr-footer__bottom">
        <ul className="fr-footer__bottom-list">
          <li className="fr-footer__bottom-item"><span
            className="fr-footer__bottom-link">Accessibilité: non conforme</span>
          </li>
          <li className="fr-footer__bottom-item">
            <a href="/mentions"
               className="fr-footer__bottom-link">Mentions
              légales</a></li>
          <li className="fr-footer__bottom-item">
            <a
              href="https://expertises.ademe.fr/lademe/infos-pratiques/politique-protection-donnees-a-caractere-personnel"
              className="fr-footer__bottom-link">Données personnelles</a></li>
          <li className="fr-footer__bottom-item">
            <a
              href="/stats"
              className="fr-footer__bottom-link">Statistiques</a></li>
        </ul>
      </div>
    </div>
  </footer>;
