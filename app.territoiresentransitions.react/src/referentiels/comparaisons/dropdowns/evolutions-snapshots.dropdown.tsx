...
import { DeleteSnapshotButton } from '@/app/referentiels/comparaisons/deleteSnapshot/delete-snapshot.button';
import { UpdateSnapshotNameButton } from '@/app/referentiels/comparaisons/updateSnapshotName/update-snapshot-name.button';
