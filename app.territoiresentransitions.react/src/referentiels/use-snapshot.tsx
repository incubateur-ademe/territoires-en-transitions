...
export function useAction(actionId: string, forceCollectiviteId?: number) {
...
export function useScore(actionId: string, forceCollectiviteId?: number) {
  const { data: action } = useAction(actionId, forceCollectiviteId);
