  ...
  <div class="grid">
    ...
    <div class="card">
      ...
      <button
        ...
        on:click|preventDefault={() => (showAddDialog = !showAddDialog)}
...
{#if showAddDialog}
  <AddDialog epcis={allEpcis} on:AddDialogClose={handleDialogClose} />
{/if}
