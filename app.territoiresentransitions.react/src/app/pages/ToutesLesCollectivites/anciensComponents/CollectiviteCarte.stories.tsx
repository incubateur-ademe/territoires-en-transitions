...
const Template: StoryFn<TCollectiviteCarteProps> = args => (
  <ul>
    <CollectiviteCarte {...args} />
  </ul>
);

export const CarteCollectiviteAuNomCourt = {
  render: Template,
...
export const CarteCollectiviteAuNomLong = {
  render: Template,
...
export const CarteCollectiviteSyndicat = {
  render: Template,
