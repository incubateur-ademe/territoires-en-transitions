...
import DeleteTagModal from '@/app/ui/modals/delete-tag-modal';
import UpdateTagModal from '@/app/ui/modals/update-tag-modal';
    ...
    <>
      ...
      {isDeleteModalOpen && (
        <DeleteTagModal
          ...
          onDelete={() => deleteTag(parseInt(tag.tagId))}
        />
      )}
    </>
  );
