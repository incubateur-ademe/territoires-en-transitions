...
const ImporterPlan = ({onBackClick}: Props) => {
  return (
    <div className="flex flex-col max-w-3xl mx-auto py-14 px-24 bg-gray-100">
      ...
      <p>
        Nous nous chargerons de l’importer sur la plateforme pour vous permettre
        de démarrer le suivi de votre plan d’action !
      </p>
