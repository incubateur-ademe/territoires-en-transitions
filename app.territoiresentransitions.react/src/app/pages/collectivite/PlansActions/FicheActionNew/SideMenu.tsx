  ...
  return (
    <div
      className={classNames(
        'absolute z-[800] top-0 h-screen max-h-screen overflow-x-scroll w-[50%] lg:w-[33%] xl:w-[30%] bg-white rounded-l-lg border-l border-l-grey-3 transition-all duration-500',
        {
