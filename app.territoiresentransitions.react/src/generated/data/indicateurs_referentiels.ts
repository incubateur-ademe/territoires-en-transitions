...
} from "../models/indicateur_referentiel";
...
export const indicateurs: IndicateurReferentiel[] = [
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur r\u00e9sidentiel.\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur tertiaire.\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur du transport routier.\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur des autres transport (hors routier).\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
        thematique_id: "mobilites",
        unite: "teq CO2"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur de l\u0027agriculture.\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur des d\u00e9chets.\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire exprim\u00e9es en tonnes \u00e9quivalent CO2 pour le secteur de l\u0027industrie hors branche \u00e9nergie.\u003c/p\u003e\n\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global\u003c/p\u003e\n\u003cp\u003e\u00c9missions de gaz \u00e0 effet de serre globales annuelles du territoire (teq CO2)\u003c/p\u003e\n",
        thematique_id: "dev_eco",
        unite: "teq CO2"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eCet indicateur estime la consommation \u00e9nerg\u00e9tique finale annuelle du territoire, selon les exigences r\u00e9glementaires des PCAET (d\u00e9cret n\u00b02016-849 du 28 juin 2016 et arr\u00eat\u00e9 du 4 ao\u00fbt 2016 relatifs au plan climat-air-\u00e9nergie territorial).\u003c/p\u003e\n",
        thematique_id: "strategie",
        unite: "GWh"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003ePour faciliter les comparaisons, l\u2019indicateur est ramen\u00e9 au nombre d\u2019habitants (population municipale selon l\u2019INSEE). Pr\u00e9ciser l\u0027ann\u00e9e de r\u00e9f\u00e9rence en commentaire. L\u0027\u00e9valuation est bas\u00e9e sur l\u0027\u00e9volution de l\u0027indicateur.\u003c/p\u003e\n",
        thematique_id: "strategie",
        unite: "MWh/hab.an"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eD\u00e9composition par secteur r\u00e9glementaire de l\u0027indicateur global 2a:\u003c/p\u003e\n\u003cp\u003eConsommation \u00e9nerg\u00e9tique globale annuelle du territoire (GWh).\u003c/p\u003e\n",
        thematique_id: "batiments",
        unite: "GWh"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eCet indicateur mesure la production d\u2019\u00e9nergie renouvelable totale sur le territoire, selon les exigences r\u00e9glementaires des PCAET (d\u00e9cret n\u00b02016-849 du 28 juin 2016 et arr\u00eat\u00e9 du 4 ao\u00fbt 2016 relatifs au plan climat-air-\u00e9nergie territorial), c\u0027est \u00e0 dire incluant les fili\u00e8res de production:\u003c/p\u003e\n\u003cul\u003e\n\u003cli\u003e\n\u003cp\u003ed\u2019\u00e9lectricit\u00e9: \u00e9olien  terrestre, solaire  photovolta\u00efque, solaire  thermodynamique,  hydraulique,  biomasse  solide, biogaz, g\u00e9othermie\u003c/p\u003e\n\u003c/li\u003e\n\u003cli\u003e\n\u003cp\u003ede  chaleur: biomasse  solide,  pompes  \u00e0  chaleur,  g\u00e9othermie,  solaire  thermique,  biogaz\u003c/p\u003e\n\u003c/li\u003e\n\u003cli\u003e\n\u003cp\u003ede biom\u00e9thane et de biocarburants.\u003c/p\u003e\n\u003c/li\u003e\n\u003c/ul\u003e\n\u003cp\u003ePr\u00e9ciser l\u0027ann\u00e9e de r\u00e9f\u00e9rence en commentaire.\u003c/p\u003e\n",
        thematique_id: "strategie",
        unite: "MWh"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eD\u00e9clinaison en % de la consommation \u00e9nerg\u00e9tique du territoire de l\u0027indicateur 3a:\u003c/p\u003e\n\u003cp\u003eProduction d\u2019\u00e9nergie renouvelable globale du territoire (MWh).\u003c/p\u003e\n",
        thematique_id: "strategie",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eIl s\u0027agit de la mesure de la consommation ou de la r\u00e9introduction d\u0027espaces naturels et agricoles au fil des ans gr\u00e2ce au suivi des surfaces r\u00e9serv\u00e9es \u00e0 ces usages dans les PLU, mesur\u00e9 en pourcentage de la surface totale de la collectivit\u00e9 (ha cumul\u00e9 des zones N et A/ha total). Ces surfaces sont non imperm\u00e9abilis\u00e9es, capteuses de CO2, productrices de ressources alimentaires, \u00e9nerg\u00e9tiques, et de biodiversit\u00e9. La valeur obtenue doit \u00eatre compar\u00e9e avec l\u0027indicateur issu de la pr\u00e9c\u00e9dente version du document d\u0027urbanisme de la collectivit\u00e9.\u003c/p\u003e\n",
        thematique_id: "urbanisme",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u0027indicateur mesure la consommation \u00e9nerg\u00e9tique totale (toute \u00e9nergie, tout usage) du patrimoine b\u00e2ti \u00e0 la charge directe de la commune, en \u00e9nergie finale. Les piscines et patinoires, si elles sont \u00e0 la charge de la collectivit\u00e9 sont prises en compte, mais pas les services publics eau, assainissement, d\u00e9chets, ni l\u0027\u00e9clairage public.\u003c/p\u003e\n",
        thematique_id: "batiments",
        unite: "MWh"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u0027indicateur mesure la consommation \u00e9nerg\u00e9tique totale (toute \u00e9nergie, tout usage) du patrimoine b\u00e2ti \u00e0 la charge directe de la commune, en \u00e9nergie finale, rapport\u00e9e par rapport \u00e0 la surface. Les piscines et patinoires, si elles sont \u00e0 la charge de la collectivit\u00e9 sont prises en compte, mais pas les services publics eau, assainissement, d\u00e9chets, ni l\u0027\u00e9clairage public.\u003c/p\u003e\n",
        thematique_id: "batiments",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u2019indicateur est en \u00e9nergie finale et inclut les consommations pour la signalisation et l\u2019\u00e9clairage du mobilier urbain (ex\u00a0: abri-bus). La valeur limite est inspir\u00e9e (valeur moyenne arrondie) de l\u2019enqu\u00eate ADEME-AITF-EDF-GDF \u00ab\u00a0Energie et patrimoine communal 2012\u00a0\u00bb, en \u00e9nergie finale. La valeur cible correspond aux meilleures scores obtenues par des collectivit\u00e9s Cit\u2019ergie.\u003c/p\u003e\n\u003cp\u003ePour les EPCI, l\u2019indicateur n\u2019est renseign\u00e9 que si la comp\u00e9tence a \u00e9t\u00e9 transf\u00e9r\u00e9e totalement (pas uniquement sur les zones communautaires).\u003c/p\u003e\n\u003cul\u003e\n\u003cli\u003e\n\u003cp\u003eValeur limite : 90 kWh/hab (\u00e9nergie finale, d\u0027apr\u00e8s donn\u00e9es enqu\u00eate AITF 2012, pour les villes moyennes)\u003c/p\u003e\n\u003c/li\u003e\n\u003cli\u003e\n\u003cp\u003eValeur cible : 60 kWh/hab\u003c/p\u003e\n\u003c/li\u003e\n\u003c/ul\u003e\n",
        thematique_id: "energie",
        unite: "kWh/hab.an"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eCet indicateur est le ratio entre la consommation d\u0027\u00e9nergie pour le chauffage assur\u00e9e par le(s) r\u00e9seau(x) de chaleur ENR\u0026amp;R et la consommation totale d\u0027\u00e9nergie pour le chauffage du territoire (pour le r\u00e9sidentiel et le tertiaire, donc hors industrie).\u003c/p\u003e\n\u003cp\u003eLa valeur limite (10%) est bas\u00e9e sur le taux moyen de couverture des besoins de chaleur par les r\u00e9seaux de chaleur en Europe (source : AMORCE).\u003c/p\u003e\n\u003cul\u003e\n\u003cli\u003eATTENTION: Les r\u00e9seaux de chaleur 100% fossiles ne sont pas pris en compte ici.\u003c/li\u003e\n\u003c/ul\u003e\n",
        thematique_id: "energie",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eLes SEM et r\u00e9gies peuvent, en plus de leur propre production d\u2019\u00e9nergies renouvelables, acheter de l\u0027\u00e9lectricit\u00e9 renouvelable ou verte (labellis\u00e9e) pour compl\u00e9ter leur offre. Les objectifs fix\u00e9s (production et achat) sont bas\u00e9s sur les objectifs 2030 de la loi de transition \u00e9nerg\u00e9tique.\u003c/p\u003e\n\u003cp\u003eValeur cible\u202f:\u003c/p\u003e\n\u003cul\u003e\n\u003cli\u003e\n\u003cp\u003e40% (M\u00e9tropole)  ;\u003c/p\u003e\n\u003c/li\u003e\n\u003cli\u003e\n\u003cp\u003e100% (DOM)\u003c/p\u003e\n\u003c/li\u003e\n\u003c/ul\u003e\n",
        thematique_id: "energie",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eIl s\u0027agit du nombre moyen de voyages en transport en commun effectu\u00e9 chaque ann\u00e9e par un habitant. Source de l\u0027indicateur : L\u0027ann\u00e9e 2007 des transports urbains, GART \u2013 Enqu\u00eate annuelle sur les transports urbains (CERTU-DGITMGART-UTP) sur 192 r\u00e9seaux.\u003c/p\u003e\n\u003cul\u003e\n\u003cli\u003e\n\u003cp\u003eValeur limite : 32 (\u0026lt;100 000 hab) et 64 (\u0026gt;100 000 hab)\u003c/p\u003e\n\u003c/li\u003e\n\u003cli\u003e\n\u003cp\u003eValeur cible : 114 (\u0026lt;100 000 hab) et 140 (\u0026gt;100 000 hab)\u003c/p\u003e\n\u003c/li\u003e\n\u003c/ul\u003e\n",
        thematique_id: "mobilites",
        unite: "voyages/hab"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eD\u00e9clinaison par habitant.  Pour les collectivit\u00e9s comp\u00e9tentes en la mati\u00e8re, des valeurs de r\u00e9f\u00e9rences ramen\u00e9es au nombre d\u0027habitants sont donn\u00e9es \u00e0 titre indicatif : valeur limite 5 euros/hab.an, valeur cible 10 euros/hab.an (source observatoire des mobilit\u00e9s actives, ADEME 2016)\u003c/p\u003e\n",
        thematique_id: "mobilites",
        unite: "euros/hab.an"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eLes kWhcumac valoris\u00e9s chaque ann\u00e9e par la collectivit\u00e9 sont calcul\u00e9s selon les modalit\u00e9s r\u00e8glementaires du dispositif des certificats d\u0027\u00e9conomie d\u0027\u00e9nergie. Il s\u0027agit de ceux dont la rente revient \u00e0 la collectivit\u00e9.\u003c/p\u003e\n",
        thematique_id: "strategie",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003ePart des march\u00e9s (en nombre) int\u00e9grant des clauses environnementales dans les sp\u00e9cifications techniques ou les crit\u00e8res d\u2019attribution en augmentation\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u0027indicateur mesure le montant des d\u00e9penses engag\u00e9es pour les projets de coop\u00e9ration significatifs et multi-acteurs par an sur le climat, l\u2019air et l\u2019\u00e9nergie (hors coop\u00e9ration d\u00e9centralis\u00e9e), rapport\u00e9 au budget total (investissement et fonctionnement) de la collectivit\u00e9.\u003c/p\u003e\n",
        thematique_id: "parten_coop",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eIl s\u0027agit du nombre de manifestions/actions de communication men\u00e9es sur le th\u00e8me de l\u0027\u00e9nergie et du climat. L\u0027\u00e9valuation est diff\u00e9renci\u00e9e selon la taille de la collectivit\u00e9. Cet indicateur fait partie d\u0027un ensemble (indicateurs qualitatifs et quantitatifs).\u003c/p\u003e\n\u003cp\u003eValeur limite : 2 (\u0026lt; 3 000 hab) ; 5 (\u0026gt; 3 000 hab) ; 10 (\u0026gt; 50 000 hab)\u003c/p\u003e\n\u003cp\u003eLes actions importantes peuvent \u00eatre compt\u00e9es comme \u00e9quivalentes \u00e0 deux actions.\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u2019indicateur mesure annuellement le nombre de m\u00e9nages demandeurs et b\u00e9n\u00e9ficiaires du fond de solidarit\u00e9 logement (FSL) pour l\u2019aide au paiement des factures d\u2019\u00e9nergie sur le territoire. Il peut \u00eatre obtenu aupr\u00e8s des Conseils D\u00e9partementaux qui g\u00e8rent ce fond (indicateur suivi au niveau national par l\u2019office national de la pr\u00e9carit\u00e9 \u00e9nerg\u00e9tique).\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u2019indicateur mesure le nombre de dossier d\u00e9pos\u00e9s chaque ann\u00e9e aupr\u00e8s de l\u2019ANAH dans le cadre du programme Habiter mieux. Ce programme vise les propri\u00e9taires occupants (sous conditions de ressources) et les propri\u00e9taires bailleurs.\u003c/p\u003e\n",
        thematique_id: "preca_energie",
        unite: "Non trouv\u00e9"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre d\u0027h\u00e9bergements labellis\u00e9s Ecolabel Europ\u00e9en / Total d\u0027h\u00e9bergements touristiques sur le territoire\u003c/p\u003e\n\u003cp\u003e(Indicateur compl\u00e9mentaire : Nombre d\u2019h\u00e9bergements labellis\u00e9s Ecolabel Europ\u00e9en)\u003c/p\u003e\n",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eIndicateur exig\u00e9 dans la r\u00e8glementation PCAET (diagnostic). Arr\u00eat\u00e9 du 4 ao\u00fbt 2016 relatif au plan climat-air-\u00e9nergie territorial. Ramen\u00e9 \u00e0 l\u2019hectare pour comparaison.\u003c/p\u003e\n",
        thematique_id: "agri_alim",
        unite: "tonne/ha"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u2019indicateur mesure le ratio moyen de viande par repas\u00a0: la quantit\u00e9 totale annuelle de viande achet\u00e9e dans la restauration collectivit\u00e9 publique (ma\u00eetris\u00e9e par la collectivit\u00e9) est divis\u00e9e par le nombre de repas servi sur l\u2019ann\u00e9e.\u003c/p\u003e\n",
        thematique_id: "agri_alim",
        unite: "g/repas"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eL\u0027indicateur mesure le % de surfaces foresti\u00e8res certifi\u00e9es FSC ou PEFC (par rapport \u00e0 la surface foresti\u00e8re totale). Les objectifs sont bas\u00e9s sur les valeurs moyennes fran\u00e7aises et des dires d\u0027experts \u00a0ADEME.\u003c/p\u003e\n",
        thematique_id: "foret_biodiv",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre d\u0027heures de consultations et de conseil sur l\u0027\u00e9nergie et la construction pour 100 hab / an\u003c/p\u003e\n\u003cul\u003e\n\u003cli\u003e\n\u003cp\u003eValeur limite = 10 min /100 hab\u003c/p\u003e\n\u003c/li\u003e\n\u003cli\u003e\n\u003cp\u003eValeur cible = 60 min / 100 hab\u003c/p\u003e\n\u003c/li\u003e\n\u003c/ul\u003e\n",
        thematique_id: "parten_coop",
        unite: "Non trouv\u00e9"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre de Services avec au moins un salari\u00e9 actuellement pr\u00e9sent a \u00e9t\u00e9 form\u00e9 \u00e0 l\u0027Economie Circulaire dans les 4 derni\u00e8res ann\u00e9es/ Nombre de services de la collectivit\u00e9 * 100. Les Unit\u00e9 de Gestion (Services) incluent toutes les th\u00e9matiques et secteurs, y compris fonctions support.\u003c/p\u003e\n",
        thematique_id: "orga_interne",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre de formations en lien avec l\u0027Economie Circulaire / Nombre total de formations suivis par les agents *100\u003c/p\u003e\n",
        thematique_id: "orga_interne",
        unite: "nombre"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003ePoids de DMA produits sur le territoire / Population du territoire\u003c/p\u003e\n",
        thematique_id: "dechets",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003ePoids de d\u00e9chets soumis \u00e0 la collecte s\u00e9par\u00e9e (d\u0027apr\u00e8s le r\u00e8glement de collecte) / Poids des OMR et de la benne tout venant des d\u00e9ch\u00e8teries.\u003c/p\u003e\n\u003cp\u003eM\u00e9thode d\u0027\u00e9chantillonnage : https://www.sinoe.org/contrib/ademe/carademe/pages/guide_OMCS_echant1.php\u003c/p\u003e\n",
        thematique_id: "dechets",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eEvolution des \u00e9quipements de transport de d\u00e9chet vers des v\u00e9hicules GNV ou biogaz, par voie fluviale, par voie ferroviaire, par v\u00e9hicules \u00e9lectriques, mobilit\u00e9 douce ou active, \u2026\u003c/p\u003e\n",
        thematique_id: "dechets",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eEquivalent en tonnes de CO2 par an / tonne de d\u00e9chets entrant\u003c/p\u003e\n",
        thematique_id: "dechets",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre de kilom\u00e8tres parcourues * Facteur d\u0027\u00e9mission des v\u00e9hicules utilis\u00e9s (eqtCO2/km)\u003c/p\u003e\n",
        thematique_id: "dechets",
        unite: "eqtCO2"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eDonn\u00e9es de suivi des objectifs de la loi AGEC articles 56 et 58 (d\u00e9cret n\u00b0 2021-254 du 9 mars 2021)\u003c/p\u003e\n\u003cp\u003eObjectif de 20% de achats reconditionn\u00e9s.\u003c/p\u003e\n",
        thematique_id: "conso_resp",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre d\u0027entreprises et d\u0027\u00e9tablissements ayant \u00e9t\u00e9 form\u00e9es \u00e0 l\u0027\u00e9coconception / Nombre d\u0027entreprises et d\u0027\u00e9tablissements sur le territoire\u003c/p\u003e\n",
        thematique_id: "dev_eco",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eSynergie est consid\u00e9r\u00e9e comme op\u00e9rationnelle \u00e0 partir d\u0027au moins un \u00e9change mati\u00e8re r\u00e9alis\u00e9\u003c/p\u003e\n",
        thematique_id: "dev_eco",
        unite: "nombre"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eQuantit\u00e9 de d\u00e9chets alimentaires produit par la restauration collective publique du territoire/ nombre de repas servis par les par la restauration collective publique du territoire. Facile \u00e0 mesurer pour la restauration scolaire et collective\u003c/p\u003e\n\u003cp\u003eObjectif l\u00e9gal (Egalim ?)\u003c/p\u003e\n",
        thematique_id: "agri_alim",
        unite: "g/repas servi"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre restaurant collectif engag\u00e9 dans une d\u00e9marche de r\u00e9duction du gaspillage alimentaire / Nombre de restaurants collectif total.\u003c/p\u003e\n",
        thematique_id: "agri_alim",
        unite: "nombre"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre d\u0027hectares artificialis\u00e9s total / Nombre d\u0027hectares des terres agricoles, naturelles et foresti\u00e8res.\u003c/p\u003e\n\u003cp\u003eDans la logique du Z\u00e9ro Artificialisation Net.\u003c/p\u003e\n",
        thematique_id: "agri_alim",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eMWh d\u0027\u00e9nergie fossile consomm\u00e9e sur le territoire/MWh d\u0027\u00e9nergie renouvelable  consomm\u00e9e sur le territoire\u003c/p\u003e\n",
        thematique_id: "energie",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eMWh d\u0027\u00e9nergie renouvelable consomm\u00e9e sur le territoire / MWh d\u0027\u00e9nergie renouvelable produite sur le territoire *100\u003c/p\u003e\n",
        thematique_id: "energie",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eVolume d\u0027eau consomm\u00e9e sur le territoire/ volume d\u0027eau dirig\u00e9e vers le territoire\u003c/p\u003e\n",
        thematique_id: "eau",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eD\u0027apr\u00e8s la liste des professions et cat\u00e9gorie socioprofessionnelles \u00e9tablie par l\u0027observatoire national des emploi et m\u00e9tiers de l\u0027\u00e9conomie verte (ONEMEV).\u003c/p\u003e\n",
        thematique_id: "dev_eco",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eNombre d\u0027entreprises ayant un code NAF associ\u00e9 \u00e0 la r\u00e9paration/nombre total d\u0027entreprises sur le territoire.\u003c/p\u003e\n",
        thematique_id: "dev_eco",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e% des comp\u00e9tences obligatoires et facultatives exerc\u00e9es par la collectivit\u00e9 (mobilit\u00e9, urbanisme, etc.) pour lesquelles l\u2019\u00e9quipe Economie Circulaire a co-construit au moins une action favorisant l\u2019Economie Circulaire dans les 4 derni\u00e8res ann\u00e9es\u003c/p\u003e\n",
        thematique_id: "strategie",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e% des strat\u00e9gies ou des politiques dans lesquelles l\u2019\u00e9quipe Economie Circulaire a \u00e9t\u00e9 associ\u00e9e pour leur conception\u003c/p\u003e\n",
        thematique_id: "strategie",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e% de la population de la collectivit\u00e9 couverte par la TI\u003c/p\u003e\n",
        thematique_id: "strategie",
        unite: "%"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003ePour le p\u00e9rim\u00e8tre de l\u0027\u00e9conomie de la fonctionnalit\u00e9 - voir les fiches ressources du R\u00e9f\u00e9rentiel Economie Circulaire\u003c/p\u003e\n",
        thematique_id: "dev_eco",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eLes projets peuvent porter sur des sujets techniques, technologiques, organisationnels ou de mod\u00e8les d\u0027affires. Si la collectivit\u00e9 souhaite aller plus loin dans le suivi, elle peut prendre en compte l\u0027ampleur des projets (budgets, nombre de partenaires, etc.).\u003c/p\u003e\n",
        thematique_id: "dev_eco",
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003e[Total des budgets de projets Economie Circulaire soutenus par la collectivit\u00e9]-[Total d\u0027aide financi\u00e8re apport\u00e9e aux projets Economie Circulaire par la collectivit\u00e9] / [Total d\u0027aide financi\u00e8re apport\u00e9e aux projets Economie Circulaire par la collectivit\u00e9]\u003c/p\u003e\n",
        thematique_id: "dev_eco",
        unite: "Euros"
    }),
    ...
    new IndicateurReferentiel({
        ...
        description: "\u003cp\u003eVoir la m\u00e9thode de calcul de la matrice des co\u00fbts\u003c/p\u003e\n",
        thematique_id: "dechets",
