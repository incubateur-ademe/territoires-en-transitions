...
import { useMesurePilotesList } from '@/app/referentiels/actions/use-action-pilotes';
import { useMesureServicesPilotesList } from '@/app/referentiels/actions/use-action-services-pilotes';
...
export const ActionHeader = ({
  ...
  const { data: pilotes } = useMesurePilotesList(action.actionId);
  const { data: services } = useMesureServicesPilotesList(action.actionId);
